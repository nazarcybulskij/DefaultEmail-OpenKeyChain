 ...
 * Original file: /home/nazar/Androidproject/krypto_email/Email_crypt/app/src/main/java/com/indeema/emailcommon/service/IEmailService.aidl
 */
package com.indeema.emailcommon.service;
public interface IEmailService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.indeema.emailcommon.service.IEmailService
{
private static final java.lang.String DESCRIPTOR = "com.indeema.emailcommon.service.IEmailService";
...
/**
 * Cast an IBinder object into an com.indeema.emailcommon.service.IEmailService interface,
 * generating a proxy if needed.
 */
public static com.indeema.emailcommon.service.IEmailService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.indeema.emailcommon.service.IEmailService))) {
return ((com.indeema.emailcommon.service.IEmailService)iin);
}
return new com.indeema.emailcommon.service.IEmailService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.indeema.emailcommon.service.IEmailServiceCallback _arg0;
_arg0 = com.indeema.emailcommon.service.IEmailServiceCallback.Stub.asInterface(data.readStrongBinder());
long _arg1;
_arg1 = data.readLong();
long _arg2;
_arg2 = data.readLong();
...
{
data.enforceInterface(DESCRIPTOR);
com.indeema.emailcommon.provider.HostAuth _arg0;
if ((0!=data.readInt())) {
_arg0 = com.indeema.emailcommon.provider.HostAuth.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
long _arg0;
_arg0 = data.readLong();
com.indeema.emailcommon.service.SearchParams _arg1;
if ((0!=data.readInt())) {
_arg1 = com.indeema.emailcommon.service.SearchParams.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
private static class Proxy implements com.indeema.emailcommon.service.IEmailService
{
...
@Override public void loadAttachment(com.indeema.emailcommon.service.IEmailServiceCallback cb, long accountId, long attachmentId, boolean background) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
@Override public android.os.Bundle validate(com.indeema.emailcommon.provider.HostAuth hostauth) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public int searchMessages(long accountId, com.indeema.emailcommon.service.SearchParams params, long destMailboxId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public void loadAttachment(com.indeema.emailcommon.service.IEmailServiceCallback cb, long accountId, long attachmentId, boolean background) throws android.os.RemoteException;
...
public android.os.Bundle validate(com.indeema.emailcommon.provider.HostAuth hostauth) throws android.os.RemoteException;
public int searchMessages(long accountId, com.indeema.emailcommon.service.SearchParams params, long destMailboxId) throws android.os.RemoteException;
// PIM functionality (not strictly EAS specific).
