...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
    ...
    public static void initAccount() {
        ...
        NOTIFIER_URI = Uri.parse(CONTENT_NOTIFIER_URI + "/account");
    }
    ...
    public static Account restoreAccountWithId(Context context, long id) {
        return restoreContentWithId(context, Account.class,
     ...
     * TODO define sentinel values for "all", "1 month", etc.  See Account.java
     * @param value One of the {@link com.indeema.emailcommon.service.SyncWindow} constants
     */
    ...
    /**
     * @return {@link android.net.Uri} to this {@link Account} in the
     * {@code content://com.indeema.email.provider/account/UUID} format, which is safe to use
     * for desktop shortcuts.
     *
     * <p>We don't want to store _id in shortcuts, because
     * {@link com.indeema.email.provider.AccountBackupRestore} won't preserve it.
     */
    ...
    /**
     * @return {@link android.net.Uri} to an {@link Account} with a {@code uuid}.
     */
    ...
    /**
     * Parse {@link android.net.Uri} in the {@code content://com.indeema.email.provider/account/ID} format
    ...
    public static long getDefaultAccountId(final Context context, final long lastUsedAccountId) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    final long accountId = cursor.getLong(ID_PROJECTION_COLUMN);
