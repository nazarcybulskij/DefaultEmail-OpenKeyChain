 ...
 *
 * <p>Email vendor policy is a system apk named "com.indeema.email.helper".  When exists, it must
 * contain a class called "com.indeema.email.policy.EmailPolicy" with a static public method
...
public class VendorPolicyLoader {
    private static final String POLICY_PACKAGE = "com.indeema.email.policy";
     ...
     * It returns an empty {@link android.os.Bundle} when there is no policy apk (or even if the inner
