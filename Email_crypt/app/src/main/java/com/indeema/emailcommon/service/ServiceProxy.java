 ...
 * to make a service call, it should call {@link #setTask}, supplying the {@link ServiceProxy.ProxyTask} that
 * should run when the connection is ready. {@link ServiceProxy.ProxyTask#run} should implement the necessary
...
public abstract class ServiceProxy {
    ...
    /**
     * Callers that want to wait on the {@link ServiceProxy.ProxyTask} should call this immediately after calling
