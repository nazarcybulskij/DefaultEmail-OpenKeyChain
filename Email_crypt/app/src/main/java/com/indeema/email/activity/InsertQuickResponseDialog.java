...
public class InsertQuickResponseDialog extends DialogFragment {
     ...
     *
     * @param callbackFragment fragment that implements {@link InsertQuickResponseDialog.Callback}.  Or null, in which case
     * the parent activity must implement {@link InsertQuickResponseDialog.Callback}.
     */
