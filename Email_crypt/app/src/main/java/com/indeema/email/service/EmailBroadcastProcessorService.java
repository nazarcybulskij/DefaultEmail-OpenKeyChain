...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    /**
     * Entry point for {@link com.indeema.email.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.indeema.email.SecurityPolicy#onDeviceAdminReceiverMessage(android.content.Context, int)}.
     */
    ...
    /**
     * Handles {@link android.content.Intent#ACTION_BOOT_COMPLETED}.  Called on a worker thread.
     */
