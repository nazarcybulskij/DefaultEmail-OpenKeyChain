 ...
 */
package com.indeema.email.preferences;
        ...
        if (oldVersion < 1) {
            ...
            for (final Account account : accounts) {
                ...
                final Cursor ecAccountCursor = context.getContentResolver().query(
                        com.indeema.emailcommon.provider.Account.CONTENT_URI,
                        com.indeema.emailcommon.provider.Account.CONTENT_PROJECTION,
                        EmailContent.AccountColumns.EMAIL_ADDRESS + " = ?",
                        new String[] { account.getEmailAddress() },
                        null);
                final com.indeema.emailcommon.provider.Account ecAccount =
                        new com.indeema.emailcommon.provider.Account();
                ...
                final boolean notify = (ecAccount.getFlags()
                        & com.indeema.emailcommon.provider.Account.FLAGS_NOTIFY_NEW_MAIL) != 0;
                ...
                final boolean vibrate = (ecAccount.getFlags()
                        & com.indeema.emailcommon.provider.Account.FLAGS_VIBRATE) != 0;
