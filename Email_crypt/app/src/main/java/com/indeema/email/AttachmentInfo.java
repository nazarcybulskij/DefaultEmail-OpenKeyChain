...
public class AttachmentInfo {
    ...
    public static final String[] PROJECTION = new String[] {EmailContent.Attachment.RECORD_ID, EmailContent.Attachment.SIZE,
        EmailContent.Attachment.FILENAME, EmailContent.Attachment.MIME_TYPE, EmailContent.Attachment.ACCOUNT_KEY, EmailContent.Attachment.FLAGS};
    ...
    public AttachmentInfo(Context context, long id, long size, String fileName, String mimeType,
        ...
        if ((flags & EmailContent.Attachment.FLAG_POLICY_DISALLOWS_DOWNLOAD) != 0) {
            canView = false;
            canSave = false;
