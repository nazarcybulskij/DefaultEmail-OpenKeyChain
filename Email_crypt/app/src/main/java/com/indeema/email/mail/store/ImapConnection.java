...
import com.indeema.emailcommon.mail.CertificateValidationException;
...
class ImapConnection {
    ...
    /**
     * Create an {@link com.indeema.email.mail.store.imap.ImapResponseParser} from {@code mTransport.getInputStream()} and
     * set it to {@link #mParser}.
     *
     * If we already have an {@link com.indeema.email.mail.store.imap.ImapResponseParser}, we
    ...
    List<ImapResponse> getCommandResponses() throws IOException, MessagingException {
        ...
        if (!response.isOk()) {
            ...
            destroyResponses();
            throw new ImapStore.ImapException(toString, alert);
        }
        return responses;
    }
