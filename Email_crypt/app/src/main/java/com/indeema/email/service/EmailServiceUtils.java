...
import com.indeema.emailcommon.service.ServiceProxy;
...
public class EmailServiceUtils {
     ...
     * @return The result of {@link android.accounts.AccountManager#addAccount}.
     */
    ...
    public static void updateAccountManagerType(Context context,
        ...
        final Cursor c = resolver.query(Account.CONTENT_URI, Account.CONTENT_PROJECTION,
                EmailContent.AccountColumns.EMAIL_ADDRESS + "=?", new String[] { amAccount.name }, null);
        // That's odd, isn't it?
        if (c == null) return;
        try {
            if (c.moveToNext()) {
                ...
                accountValues.put(EmailContent.AccountColumns.FLAGS, account.mFlags);
                ...
                try {
                    ...
                    accountValues.put(EmailContent.AccountColumns.FLAGS, oldFlags);
                    resolver.update(accountUri, accountValues, null, null);
