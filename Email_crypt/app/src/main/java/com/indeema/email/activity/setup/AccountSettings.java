...
import com.indeema.mail.providers.UIProvider.EditSettingsExtras;
...
public class AccountSettings extends PreferenceActivity implements FeedbackEnabledActivity,
     ...
     * in {@link #onHeaderClick(android.preference.PreferenceActivity.Header, int)}.  Called after we interrupted a header switch
