...
import com.indeema.email.service.EmailServiceUtils.EmailServiceInfo;
...
import com.indeema.mail.ui.settings.SettingsUtils;
import com.indeema.mail.utils.LogUtils;
import com.indeema.mail.utils.NotificationUtils;
...
public class AccountSettingsFragment extends PreferenceFragment
    ...
    private com.indeema.mail.providers.Account mUiAccount;
    ...
    public interface Callback {
        ...
        public void onEditQuickResponses(com.indeema.mail.providers.Account account);
    ...
    private static class EmptyCallback implements Callback {
        ...
        @Override public void onEditQuickResponses(com.indeema.mail.providers.Account account) {}
     ...
     * {@link #onAttach(android.app.Activity)} and before {@link #onActivityCreated(android.os.Bundle)}.
     */
    @Override
    ...
    private class LoadAccountTask extends AsyncTask<Long, Void, Map<String, Object>> {
        ...
        protected Map<String, Object> doInBackground(Long... params) {
            ...
            try {
                if (accountCursor != null && accountCursor.moveToFirst()) {
                    uiAccount = new com.indeema.mail.providers.Account(accountCursor);
                } else {
                    uiAccount = null;
                }
            } finally {
        ...
        protected void onPostExecute(Map<String, Object> map) {
            if (!isCancelled()) {
                ...
                mUiAccount = (com.indeema.mail.providers.Account) map.get(UI_ACCOUNT_KEY);
                if (account == null) {
                    mSaveOnExit = false;
                    mCallback.abandonEdit();
                } else {
    ...
    /**
     * Loads settings that are dependent on a {@link com.indeema.mail.providers.Account}, which
