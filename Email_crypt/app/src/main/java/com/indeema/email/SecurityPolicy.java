...
public class SecurityPolicy {
    ...
    private static final String HAS_PASSWORD_EXPIRATION =
        EmailContent.PolicyColumns.PASSWORD_EXPIRATION_DAYS + ">0";
    ...
    public static void setAccountPolicy(Context context, Account account, Policy policy,
        ...
        if (policy != null) {
            ...
            ops.add(ContentProviderOperation.newUpdate(
                    ...
                    .withValueBackReference(EmailContent.AccountColumns.POLICY_KEY, 0)
                    .withValue(EmailContent.AccountColumns.SECURITY_SYNC_KEY, securitySyncKey)
                    .build());
        } else {
            ops.add(ContentProviderOperation.newUpdate(
                    ContentUris.withAppendedId(Account.CONTENT_URI, account.mId))
                    .withValue(EmailContent.AccountColumns.SECURITY_SYNC_KEY, null)
                    .withValue(EmailContent.AccountColumns.POLICY_KEY, 0)
                    .build());
        }
    ...
    /*package*/ static long findShortestExpiration(Context context) {
        long policyId = Utility.getFirstRowLong(context, Policy.CONTENT_URI, Policy.ID_PROJECTION,
                HAS_PASSWORD_EXPIRATION, null, EmailContent.PolicyColumns.PASSWORD_EXPIRATION_DAYS + " ASC",
