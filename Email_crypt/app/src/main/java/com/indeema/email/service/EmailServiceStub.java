...
import com.indeema.emailcommon.mail.Folder.MessageRetrievalListener;
...
public abstract class EmailServiceStub extends IEmailService.Stub implements IEmailService {
    ...
    private static final String[] MAILBOX_PROJECTION = new String[] {
        EmailContent.MailboxColumns.ID,
    ...
    public void loadAttachment(final IEmailServiceCallback cb, final long accountId,
        ...
        try {
            ...
            EmailContent.Attachment attachment =
                EmailContent.Attachment.restoreAttachmentWithId(mContext, attachmentId);
            if (attachment == null) {
            ...
            if (mailbox.mType == Mailbox.TYPE_OUTBOX) {
                long sourceId = Utility.getFirstRowLong(mContext, EmailContent.Body.CONTENT_URI,
                        new String[] {EmailContent.BodyColumns.SOURCE_MESSAGE_KEY},
                        EmailContent.BodyColumns.MESSAGE_KEY + "=?",
            ...
            cv.put(EmailContent.AttachmentColumns.UI_STATE, UIProvider.AttachmentState.FAILED);
            final Uri uri = ContentUris.withAppendedId(EmailContent.Attachment.CONTENT_URI, attachmentId);
    ...
    public static void sendMailImpl(Context context, long accountId) {
        ...
        try {
            ...
            if (remoteStore.requireCopyMessageToSentFolder()) {
                ...
                moveToSentValues.put(EmailContent.MessageColumns.MAILBOX_KEY, sentFolder.mId);
            } else {
