...
import com.indeema.emailcommon.utility.LoggingInputStream;
...
public class Pop3Store extends Store {
     ...
     *
     * @throws com.indeema.emailcommon.mail.MessagingException if there was some problem with the account
     */
    @Override
    ...
    public class Pop3Folder extends Folder {
         ...
         * @throws com.indeema.emailcommon.mail.MessagingException if the account is not going to be useable
         */
        public Bundle checkSettings() throws MessagingException {
