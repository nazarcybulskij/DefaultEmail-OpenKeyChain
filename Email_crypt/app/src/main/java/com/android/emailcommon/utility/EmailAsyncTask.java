...
public abstract class EmailAsyncTask<Params, Progress, Result> {
    ...
    /**
     * Tracks {@link com.android.emailcommon.utility.EmailAsyncTask}.
     *
     ...
     * {@link com.android.emailcommon.utility.EmailAsyncTask.Tracker}, and then {@link #executeParallel}.
     */
    ...
    /**
     * Cancel all previously created instances of the same class tracked by the same
     * {@link com.android.emailcommon.utility.EmailAsyncTask.Tracker}, and then {@link #executeSerial}.
     */
