...
public class Mailbox extends EmailContent implements MailboxColumns, Parcelable {
     ...
     * @param cr The {@link android.content.ContentResolver}.
     ...
     * @return The account id for the mailbox, or {@link com.android.emailcommon.provider.Account#NO_ACCOUNT} if the mailbox doesn't
     *         exist.
     */
