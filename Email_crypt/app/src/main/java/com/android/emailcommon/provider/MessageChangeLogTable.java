...
/**
 * {@link com.android.emailcommon.provider.EmailContent}-like base class for change log tables.
...
public abstract class MessageChangeLogTable {
     ...
     * @param cr A {@link android.content.ContentResolver}.
     ...
     * @param cr A {@link android.content.ContentResolver}.
     * @param uri The {@link android.net.Uri} for the update.
    ...
    /**
     * Start processing our table and get a {@link android.database.Cursor} for the rows to process.
     * @param cr A {@link android.content.ContentResolver}.
     * @param uri The {@link android.net.Uri} for the update.
     * @param projection The projection to use for our read.
     * @param accountId The account we're interested in.
     * @return A {@link android.database.Cursor} with the change log rows we're interested in.
     */
