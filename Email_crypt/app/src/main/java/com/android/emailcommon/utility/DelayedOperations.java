...
/**
 * Class that helps post {@link Runnable}s to a {@link android.os.Handler}, and cancel pending ones
 * at once.
 */
public class DelayedOperations {
    ...
    /**
     * Post a {@link Runnable} to the handler.  Equivalent to {@link android.os.Handler#post(Runnable)}.
     */
     ...
     *
     * Equivalent to {@link android.os.Handler#removeCallbacks(Runnable)}.
     */
