...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    /**
     * Entry point for {@link com.android.email.service.EmailBroadcastReceiver}.
     */
     ...
     * com.android.email.SecurityPolicy#onDeviceAdminReceiverMessage(android.content.Context, int)}.
     */
