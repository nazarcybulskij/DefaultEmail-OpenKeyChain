...
public class ImapResponseParser {
    ...
    /**
     * We store all {@link com.android.email.mail.store.imap.ImapResponse} in it.  {@link #destroyResponses()} must be called from
    ...
    /**
     * Destroy all the {@link com.android.email.mail.store.imap.ImapResponse}s stored in the internal storage and clear it.
     *
     * @see #readResponse()
     */
     ...
     * {@link com.android.email.mail.store.imap.ImapResponse} object that represents it.
     *
     * <p>When this method successfully returns an {@link com.android.email.mail.store.imap.ImapResponse}, the {@link com.android.email.mail.store.imap.ImapResponse}
     * is stored in the internal storage.  When the {@link com.android.email.mail.store.imap.ImapResponse} is no longer used
     * {@link #destroyResponses} should be called to destroy all the responses in the array.
     *
     * @return the parsed {@link com.android.email.mail.store.imap.ImapResponse} object.
     * @exception com.android.email.mail.store.imap.ImapResponseParser.ByeException when detects BYE.
     */
     ...
     * throw {@link com.android.emailcommon.mail.MessagingException}.
     */
