...
public abstract class ImapElement {
    /**
     * An element that is returned by {@link com.android.email.mail.store.imap.ImapList#getElementOrNone} to indicate an index
     * is out of range.
     */
     ...
     * mistake it for {@link com.android.email.mail.store.imap.ImapString#getString}.
     *
