...
public class AccountReconciler {
    ...
    /**
     * Get a all {@link Account} objects from the {@link com.android.email.provider.EmailProvider}.
     * @param context Our {@link android.content.Context}.
     * @return A list of all {@link Account}s from the {@link com.android.email.provider.EmailProvider}.
     */
