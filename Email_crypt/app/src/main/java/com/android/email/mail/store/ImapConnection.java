...
class ImapConnection {
     ...
     * until {@link #setStore(com.android.email.mail.store.ImapStore, String, String)} is called.
     */
    void close() {
        if (mTransport != null) {
            mTransport.close();
    ...
    /**
     * Create an {@link com.android.email.mail.store.imap.ImapResponseParser} from {@code mTransport.getInputStream()} and
     * set it to {@link #mParser}.
     *
     * If we already have an {@link com.android.email.mail.store.imap.ImapResponseParser}, we
