...
public class ImapList extends ImapElement {
    /**
     * {@link com.android.email.mail.store.imap.ImapList} representing an empty list.
     */
     ...
     * If {@code index} is out of range or not a list, returns {@link com.android.email.mail.store.imap.ImapList#EMPTY}.
     */
    ...
    /**
     * Return an {@link com.android.email.mail.store.imap.ImapList} keyed by {@code key}.
     * Return {@link com.android.email.mail.store.imap.ImapList#EMPTY} if not found.
     */
