...
public abstract class Store {
     ...
     * @throws com.android.emailcommon.mail.MessagingException If the store cannot be obtained or if the account is invalid.
     */
     ...
     *
     * @throws com.android.emailcommon.mail.MessagingException If the store cannot be removed or if the account is invalid.
     */
     ...
     * @throws com.android.emailcommon.mail.MessagingException If there was a problem connecting to the remote server
     */
