            ...
            switch (match) {
                ...
                case BODY:
                    ...
                    if (result == 0 && selection.equals(Body.SELECTION_BY_MESSAGE_KEY)) {
                        ...
                        insertValues.put(Body.MESSAGE_KEY, selectionArgs[0]);
    ...
    private static ProjectionMap getMessageListMap() {
        if (sMessageListMap == null) {
            sMessageListMap = ProjectionMap.builder()
                ...
                .add(ConversationColumns.SUBJECT, MessageColumns.SUBJECT)
                .add(ConversationColumns.SNIPPET, MessageColumns.SNIPPET)
                .add(ConversationColumns.CONVERSATION_INFO, null)
                .add(ConversationColumns.DATE_RECEIVED_MS, MessageColumns.TIMESTAMP)
                .add(ConversationColumns.HAS_ATTACHMENTS, MessageColumns.FLAG_ATTACHMENT)
                ...
                .add(ConversationColumns.READ, MessageColumns.FLAG_READ)
                .add(ConversationColumns.SEEN, MessageColumns.FLAG_SEEN)
                .add(ConversationColumns.STARRED, MessageColumns.FLAG_FAVORITE)
                ...
                .add(ConversationColumns.SENDER_INFO, MessageColumns.FROM_LIST)
                .build();
        }
    ...
    private static ProjectionMap getMessageViewMap() {
        if (sMessageViewMap == null) {
            sMessageViewMap = ProjectionMap.builder()
                .add(BaseColumns._ID, Message.TABLE_NAME + "." + MessageColumns.ID)
...
//                    }
        ...
        public Bundle respond(Bundle params) {
            ...
            if (params.containsKey(setVisibilityKey)) {
                ...
                if (visible) {
                    ...
                    final Uri uri = Message.CONTENT_URI;
    ...
    /**
     * Convenience method to create a {@link com.android.mail.providers.Folder}
     * @param context to get a {@link android.content.ContentResolver}
     * @param mailboxId id of the {@link com.android.emailcommon.provider.Mailbox} that we want
     * @return the {@link com.android.mail.providers.Folder} or null
     */
     ...
     * in the supplied {@link android.database.MatrixCursor} in the format required for {@link com.android.mail.providers.Folder}.
     ...
     * @param inputCursor A cursor containing all columns of {@link com.android.mail.providers.UIProvider.FolderColumns}.
     ...
     * to the {@link com.android.mail.providers.UIProvider.FolderType} requested.
     * @param folderType {@link com.android.mail.providers.UIProvider.FolderType} value for the folder
     * @param defaultName a {@link String} to use in case the {@link com.android.mail.providers.UIProvider.FolderType}
    ...
    /**
     * Converts a {@link com.android.emailcommon.provider.Mailbox} type value to its {@link com.android.mail.providers.UIProvider.FolderType}
     * equivalent.
     * @param mailboxType a {@link com.android.emailcommon.provider.Mailbox} type
     * @return a {@link com.android.mail.providers.UIProvider.FolderType} value
     */
     ...
     *                  {@link com.android.emailcommon.provider.Mailbox}).
    ...
    /**
     * Request a sync.
     * @param mailbox The {@link com.android.emailcommon.provider.Mailbox} we want to sync.
     * @param deltaMessageCount If we're requesting a load more, the number of additional messages
     *                          to sync.
     */
