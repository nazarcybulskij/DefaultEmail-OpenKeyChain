...
public final class PhotoContract {
    ...
    public static interface PhotoViewColumns {
        /**
         * This column is a {@link android.net.Uri} that can be queried
        ...
        /**
         * This column is a {@link android.net.Uri} that points to the downloaded local file.
         * Can be null.
         */
        public static final String CONTENT_URI = "contentUri";
        /**
         * This column is a {@link android.net.Uri} that points to a thumbnail of the image
