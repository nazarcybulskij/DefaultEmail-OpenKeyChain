...
public class Intents {
    ...
    public static class PhotoViewIntentBuilder {
         ...
         *  where the URI given to {@link com.android.ex.photo.PhotoViewActivity} points directly
         *  to a single image and does not need to be resolved via a query
         *  to the {@link android.content.ContentProvider}. If this value is set, it supersedes
