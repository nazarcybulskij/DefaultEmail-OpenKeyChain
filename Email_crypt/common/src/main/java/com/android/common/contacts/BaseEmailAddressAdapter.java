 ...
 * {@link android.provider.ContactsContract.CommonDataKinds.Email#CONTENT_FILTER_URI} to search for data rows by email address
...
public abstract class BaseEmailAddressAdapter extends CompositeCursorAdapter implements Filterable {
     ...
     * {@link com.android.common.widget.CompositeCursorAdapter} for every directory (except
