...
public class PathFileComparator implements Comparator<File>, Serializable {
    ...
    /** Case-sensitive path comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> PATH_COMPARATOR = new PathFileComparator();

    /** Reverse case-sensitive path comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> PATH_REVERSE = new ReverseComparator<File>(PATH_COMPARATOR);

    /** Case-insensitive path comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> PATH_INSENSITIVE_COMPARATOR = new PathFileComparator(IOCase.INSENSITIVE);

    /** Reverse case-insensitive path comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> PATH_INSENSITIVE_REVERSE = new ReverseComparator<File>(PATH_INSENSITIVE_COMPARATOR);

    /** System sensitive path comparator instance (see {@link org.apache.commons.io.IOCase#SYSTEM}) */
