...
public class NameFileComparator implements Comparator<File>, Serializable {
    ...
    /** Case-sensitive name comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> NAME_COMPARATOR = new NameFileComparator();

    /** Reverse case-sensitive name comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> NAME_REVERSE = new ReverseComparator<File>(NAME_COMPARATOR);

    /** Case-insensitive name comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> NAME_INSENSITIVE_COMPARATOR = new NameFileComparator(IOCase.INSENSITIVE);

    /** Reverse case-insensitive name comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> NAME_INSENSITIVE_REVERSE = new ReverseComparator<File>(NAME_INSENSITIVE_COMPARATOR);

    /** System sensitive name comparator instance (see {@link org.apache.commons.io.IOCase#SYSTEM}) */
    public static final Comparator<File> NAME_SYSTEM_COMPARATOR = new NameFileComparator(IOCase.SYSTEM);

    /** Reverse system sensitive name comparator instance (see {@link org.apache.commons.io.IOCase#SYSTEM}) */
