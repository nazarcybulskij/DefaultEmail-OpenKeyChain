 ...
 * (see {@link org.apache.commons.io.FilenameUtils#getExtension(String)}).
 * <p>
 ...
 * are provided for the various case sensitivity options (using {@link org.apache.commons.io.IOCase})
...
public class ExtensionFileComparator implements Comparator<File>, Serializable {
    ...
    /** Case-sensitive extension comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> EXTENSION_COMPARATOR = new ExtensionFileComparator();

    /** Reverse case-sensitive extension comparator instance (see {@link org.apache.commons.io.IOCase#SENSITIVE}) */
    public static final Comparator<File> EXTENSION_REVERSE = new ReverseComparator<File>(EXTENSION_COMPARATOR);

    /** Case-insensitive extension comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> EXTENSION_INSENSITIVE_COMPARATOR = new ExtensionFileComparator(IOCase.INSENSITIVE);

    /** Reverse case-insensitive extension comparator instance (see {@link org.apache.commons.io.IOCase#INSENSITIVE}) */
    public static final Comparator<File> EXTENSION_INSENSITIVE_REVERSE
                                                = new ReverseComparator<File>(EXTENSION_INSENSITIVE_COMPARATOR);

    /** System sensitive extension comparator instance (see {@link org.apache.commons.io.IOCase#SYSTEM}) */
    public static final Comparator<File> EXTENSION_SYSTEM_COMPARATOR = new ExtensionFileComparator(IOCase.SYSTEM);

    /** Reverse system sensitive path comparator instance (see {@link org.apache.commons.io.IOCase#SYSTEM}) */
