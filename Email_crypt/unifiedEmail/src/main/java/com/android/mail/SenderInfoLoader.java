...
/**
 * A {@link android.content.Loader} to look up presence, contact URI, and photo data for a set of email
 * addresses.
 *
 */
public class SenderInfoLoader extends AsyncTaskLoader<ImmutableMap<String, ContactInfo>> {
     ...
     * @param resolver {@link android.content.ContentResolver} to use in queries to the ContentProvider.
     ...
     *                      {@link com.android.mail.ContactInfo}. Otherwise, just put the raw bytes of the photo
     *                      into the {@link com.android.mail.ContactInfo}.
     * @return A mapping of email addresses to {@link com.android.mail.ContactInfo}s. The {@link com.android.mail.ContactInfo} will
