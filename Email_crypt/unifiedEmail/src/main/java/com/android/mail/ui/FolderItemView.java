...
public class FolderItemView extends RelativeLayout {
    ...
    /**
     * Returns true if the two folders lead to identical {@link com.android.mail.ui.FolderItemView} objects.
     * @param a
     * @param b
     * @return true if the two folders would still lead to the same {@link com.android.mail.ui.FolderItemView}.
     */
