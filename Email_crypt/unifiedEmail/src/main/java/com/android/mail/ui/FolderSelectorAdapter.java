...
/**
 * An adapter for translating a cursor of {@link com.android.mail.providers.Folder} to a set of selectable views to be used for
...
public class FolderSelectorAdapter extends BaseAdapter {
     ...
     * hierarchical order.
     * @param folderList List of {@link com.android.mail.providers.Folder} objects to sort
     */
        ...
        while ((currentNode = stack.poll()) != null) {
            ...
            if (parentNode != null && !currentNode.mAddedToList) {
                ...
                if (parentNode.mWrappedObject == null ||
                     ...
                     * {@link com.android.mail.ui.HierarchicalFolderSelectorAdapter#truncateHierarchy}
                     */
