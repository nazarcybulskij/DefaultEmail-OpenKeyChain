 ...
 * {@link #onChanged(com.android.mail.providers.Account[])} when the list of Accounts changes. Initializing the object
 * registers with the observer with the {@link com.android.mail.ui.AccountController} provided.
 * The object will then begin to receive {@link #onChanged(com.android.mail.providers.Account[])} till {@link
 * #unregisterAndDestroy()} is called. <p> To implement an {@link com.android.mail.providers
 * .AllAccountObserver}, you need to implement the {@link #onChanged(com.android.mail.providers.Account[])} method.
 */
public abstract class AllAccountObserver extends DataSetObserver {
     ...
     * a call to {@link #onChanged(com.android.mail.providers.Account[])} when the controller changes the list of accounts.
     *
     * @param controller
     */
