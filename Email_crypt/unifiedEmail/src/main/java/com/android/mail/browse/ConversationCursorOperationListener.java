...
public interface ConversationCursorOperationListener {
    ...
    public class OperationHelper {
        /**
         * Invokes {@link com.android.mail.browse.ConversationCursorOperationListener#markContentsSeen(android.database.Cursor)} on the
         * specified {@link android.database.Cursor}, recursively calls {@link #markContentsSeen(android.database.Cursor)} on a
        ...
        /**
         * Invokes {@link com.android.mail.browse.ConversationCursorOperationListener#emptyFolder(android.database.Cursor)} on the
         * specified {@link android.database.Cursor}, recursively calls {@link #emptyFolder(android.database.Cursor)} on a
         * wrapped cursor, or returns.
         */
