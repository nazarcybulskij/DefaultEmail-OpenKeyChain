 ...
 * {@link com.android.mail.browse.FolderSpan}s can be. They cannot exceed the TextView line width, or
 * else {@link android.text.Layout} will split up the spans in strange places.
 */
