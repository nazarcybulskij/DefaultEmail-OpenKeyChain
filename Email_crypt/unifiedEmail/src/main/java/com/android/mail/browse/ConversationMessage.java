 ...
 *
 * <p>This class must remain separate from the {@link com.android.mail.browse.MessageCursor} from whence it came,
 * because cursors can be closed by their Loaders at any time. The
 * {@link com.android.mail.browse.MessageCursor.ConversationController} intermediate is used to obtain the currently opened cursor.
 *
