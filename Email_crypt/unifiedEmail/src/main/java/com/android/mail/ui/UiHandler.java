...
/**
 * A thin wrapper of {@link android.os.Handler} to run a callback in UI thread. Any callback posted to this
 * handler is guarantee to run inside {@link android.app.Activity} life cycle. However, it can be dropped if the
...
public class UiHandler {
    ...
    /**
     * @return whether the {@link com.android.mail.ui.UiHandler} is enabled. It's safe to edit UI if the
     *         {@link com.android.mail.ui.UiHandler} is enabled.
     */
