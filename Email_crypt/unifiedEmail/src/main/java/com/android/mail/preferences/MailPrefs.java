...
public final class MailPrefs extends VersionedPrefs {
     ...
     * Should be one of the {@link com.android.mail.preferences.MailPrefs.RemovalActions}.
     */
     ...
     * @param removalAction The preferred {@link com.android.mail.preferences.MailPrefs.RemovalActions}.
     */
    ...
    /**
     * Gets the action to take (one of the values from {@link com.android.mail.providers.UIProvider.Swipe}) when an item in the
