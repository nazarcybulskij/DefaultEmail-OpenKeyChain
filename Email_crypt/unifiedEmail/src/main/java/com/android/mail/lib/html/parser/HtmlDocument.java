...
public class HtmlDocument {
   ...
   * @see com.android.mail.lib.html.parser.HtmlDocument#createTag(com.android.mail.lib.html.parser.HTML.Element, java.util.List, String, String)
   */
  ...
  /**
   * Creates start Tag Node.
   * @see com.android.mail.lib.html.parser.HtmlDocument.Tag#Tag(com.android.mail.lib.html.parser.HTML.Element, java.util.List, boolean, String, String)
   */
   ...
   * @see com.android.mail.lib.html.parser.HtmlDocument#createSelfTerminatingTag(com.android.mail.lib.html.parser.HTML.Element, java.util.List, String, String)
   */
  ...
  /**
   * @see com.android.mail.lib.html.parser.HtmlDocument#createEndTag(com.android.mail.lib.html.parser.HTML.Element, String)
   */
  ...
  /**
   * @see com.android.mail.lib.html.parser.HtmlDocument.EndTag#EndTag(com.android.mail.lib.html.parser.HTML.Element, String)
   */
  ...
  /**
   * @see com.android.mail.lib.html.parser.HtmlDocument#createTagAttribute(com.android.mail.lib.html.parser.HTML.Attribute, String, String)
   */
  ...
  /**
   * @see com.android.mail.lib.html.parser.HtmlDocument.TagAttribute#TagAttribute(com.android.mail.lib.html.parser.HTML.Attribute, String, String)
   */
  ...
  /**
   * @see com.android.mail.lib.html.parser.HtmlDocument#createText(String, String)
   */
  ...
  /**
   * Creates a Text node.
   * @see com.android.mail.lib.html.parser.HtmlDocument.UnescapedText#UnescapedText(String, String)
   */
   ...
   * @see com.android.mail.lib.html.parser.HtmlDocument.Comment#Comment(String)
   */
   ...
   * @see com.android.mail.lib.html.parser.HtmlDocument.CDATA#CDATA(String)
   */
  ...
  public static abstract class Text extends Node {
    ...
    /**
     * @see com.android.mail.lib.html.parser.HtmlDocument.Text#toHTML(StringBuilder)
     */
    @Override
    public void toXHTML(StringBuilder sb) {
      toHTML(sb);
     ...
     * (see constructor argument of {@link com.android.mail.lib.html.parser.HtmlParser})
     */
  ...
  /**
   * {@link com.android.mail.lib.html.parser.HtmlDocument.Text} implementation where the given text is assumed to have been
  ...
  /**
   * {@link com.android.mail.lib.html.parser.HtmlDocument.Text} implementation where the given text is not unescaped yet, and
  ...
  /**
   * Converts a normal {@link com.android.mail.lib.html.parser.HtmlDocument.Filter} into a {@link com.android.mail.lib.html.parser.HtmlDocument.MultiplexFilter}.
   */
  ...
  public static abstract class SimpleMultiplexFilter implements MultiplexFilter {
    ...
    /**
     * @see com.android.mail.lib.html.parser.HtmlDocument.MultiplexFilter#filter(com.android.mail.lib.html.parser.HtmlDocument.Node, java.util.List)
     */
    public void filter(Node originalNode, List<Node> out) {
      if (originalNode == null) {
        return;
  ...
  public static class MultiplexFilterChain implements MultiplexFilter {
    ...
    /**
     * @see com.android.mail.lib.html.parser.HtmlDocument.MultiplexFilter#start()
     */
    public void start() {
    ...
    /**
     * @see com.android.mail.lib.html.parser.HtmlDocument.MultiplexFilter#finish(java.util.List)
     */
    public void finish(List<Node> out) {
      List<Node> result = new ArrayList<Node>();
  ...
  public static class Builder implements Visitor {
    ...
    /**
     * @see com.android.mail.lib.html.parser.HtmlDocument.Builder#Builder(boolean)
     */
    public Builder() {
      this(false);
    }
