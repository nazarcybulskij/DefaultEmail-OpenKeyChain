...
class AttachmentsView extends LinearLayout {
    ...
    /**
     * Generate an {@link com.android.mail.providers.Attachment} object for a given local content URI. Attempts to populate
     * the {@link com.android.mail.providers.Attachment#name}, {@link com.android.mail.providers.Attachment#size}, and {@link com.android.mail.providers.Attachment#contentType}
     * fields using a {@link android.content.ContentResolver}.
     *
     * @param contentUri
     * @return an Attachment object
     * @throws com.android.mail.compose.AttachmentsView.AttachmentFailureException
     */
     ...
     * @throws com.android.mail.compose.AttachmentsView.AttachmentFailureException if an error occurs adding the attachment.
     */
