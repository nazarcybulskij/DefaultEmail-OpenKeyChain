...
public class NotificationUtils {
     ...
     *                       False, otherwise.
     * @param accountUri The {@link android.net.Uri} of the {@link com.android.mail.providers.Account} of the notification
     *                   upon which an action occurred.
     * @param folderUri The {@link android.net.Uri} of the {@link com.android.mail.providers.Folder} of the notification
     *                  upon which an action occurred.
     */
     ...
     * @param context
     * @param subject Subject of the new message that triggered the notification
     * @param message the {@link com.android.mail.providers.Message} to be displayed.
     * @return a {@link CharSequence} suitable for use in
     *         {@link android.support.v4.app.NotificationCompat.BigTextStyle}
     */
     ...
     * to be stored in {@link com.android.mail.preferences.AccountPreferences}. If it is still there, we need to move it to the
     * {@link com.android.mail.preferences.FolderPreferences} now.
     */
