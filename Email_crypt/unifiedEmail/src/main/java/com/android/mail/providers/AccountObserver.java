...
/**
 * A simple extension of {@link android.database.DataSetObserver} to provide the updated account in
 * {@link #onChanged(com.android.mail.providers.Account)} when the account changes. Initializing the object registers with
 * the observer with the {@link com.android.mail.ui.AccountController} provided. The object will then begin to
 * receive {@link #onChanged(com.android.mail.providers.Account)} till {@link #unregisterAndDestroy()} is called.
 * <p>
 * To implement an {@link com.android.mail.providers.AccountObserver}, you need to implement the {@link #onChanged(com.android.mail.providers.Account)}
 * method.
 */
public abstract class AccountObserver extends DataSetObserver {
    ...
    /**
     * Initializes an {@link com.android.mail.providers.AccountObserver} object that receives a call to
     * {@link #onChanged(com.android.mail.providers.Account)} when the controller changes the account.
     *
     * @param controller
     */
    ...
    /**
     * Callback invoked when the account object is changed.  Since {@link com.android.mail.providers.Account} objects are
