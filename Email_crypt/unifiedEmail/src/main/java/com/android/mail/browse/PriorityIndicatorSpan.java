...
/**
 * Acts like an {@link android.text.style.ImageSpan}, with some important distinctions:
 * <ol>
 * <li>modifies font metrics in a manner consistent with {@link com.android.mail.browse.FolderSpan}
 * (will not increase line height beyond {@link com.android.mail.browse.FolderSpan} height)</li>
 * <li>draws its image vertically centered within its line</li>
 * <li>allows horizontal and vertical padding</li>
 * </ol>
 * Much of this code was copied from {@link android.text.style.DynamicDrawableSpan} and ImageSpan
 * because
 * {@link android.text.style.DynamicDrawableSpan#draw(android.graphics.Canvas, CharSequence, int, int, float, int, int, int, android.graphics.Paint)}
