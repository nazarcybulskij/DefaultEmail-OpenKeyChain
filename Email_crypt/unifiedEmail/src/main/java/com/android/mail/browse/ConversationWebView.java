...
public class ConversationWebView extends MailWebView implements ScrollNotifier {
    ...
    /**
     * Destroys the {@link android.graphics.Bitmap} used for software layer.
     */
     ...
     * a normal {@link #onDraw(android.graphics.Canvas)} happens, and will overwrite whatever is normally drawn
    ...
    /**
     * Notifies the {@link com.android.mail.browse.ConversationWebView} that it has become visible. It can use this signal
