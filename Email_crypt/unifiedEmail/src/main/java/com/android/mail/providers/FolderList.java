...
/**
 * Simple class to encapsulate an immutable list of {@link com.android.mail.providers.Folder} objects, and handle serialization
...
public class FolderList implements Parcelable {
    ...
    /**
     * Directly turns a list of {@link com.android.mail.providers.Folder}s into a byte-array. Avoids the
     * list-copy overhead of {@link #copyOf(java.util.Collection)} + {@link #toBlob()}.
     *
     * @param in a list of Folders
     * @return the marshalled byte-array form of a {@link com.android.mail.providers.FolderList}
     */
