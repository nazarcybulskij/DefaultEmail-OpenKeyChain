...
/**
 * Simple utility class to make an asynchronous {@link android.content.ContentProvider} request expressed as
 * a list of {@link android.content.ContentProviderOperation}s. As with all {@link android.os.AsyncTask}s, subclasses should
 * override {@link #onPostExecute(Object)} to handle success/failure.
 *
 * @see com.android.mail.utils.ContentProviderTask.InsertTask
 * @see com.android.mail.utils.ContentProviderTask.UpdateTask
 * @see com.android.mail.utils.ContentProviderTask.DeleteTask
 *
 */
