...
public class ConversationItemViewCoordinates {
     ...
     * instance per item, and {@link #forConfig(android.content.Context, com.android.mail.browse.ConversationItemViewCoordinates.Config, android.util.SparseArray)} uses it to hide/show
