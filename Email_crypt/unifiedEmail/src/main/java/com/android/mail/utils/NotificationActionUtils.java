...
public class NotificationActionUtils {
    ...
    /**
     * If an {@link com.android.mail.utils.NotificationActionUtils.NotificationAction} exists here for a given notification key, then we should
    ...
    /**
     * If a {@link com.android.mail.providers.Conversation} exists in this set, then the undo notification for this
     * {@link com.android.mail.providers.Conversation} was tapped by the user in the notification drawer.
     ...
     *
     * @param folder The {@link com.android.mail.providers.Folder} being notified
    ...
    /**
     * Creates and displays an Undo notification for the specified {@link com.android.mail.utils.NotificationActionUtils.NotificationAction}.
     */
