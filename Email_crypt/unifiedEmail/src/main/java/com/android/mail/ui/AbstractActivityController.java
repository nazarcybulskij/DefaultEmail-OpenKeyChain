...
public abstract class AbstractActivityController implements ActivityController,
    ...
    /** Tag for {@link com.android.mail.ui.ActionableToastBar#getOperation()} */
    ...
    /** Tag for {@link com.android.mail.ConversationListContext#searchQuery} */
    ...
    /** A map of {@link com.android.mail.providers.Folder} {@link android.net.Uri} to scroll position in the conversation list. */
    ...
    /** Object that listens to all LoaderCallbacks that result in {@link com.android.mail.providers.Folder} creation. */
    private final FolderLoads mFolderCallbacks = new FolderLoads();
    /** Object that listens to all LoaderCallbacks that result in {@link com.android.mail.providers.Account} creation. */
     ...
     * The loader is always restarted when an account is set in {@link #setAccount(com.android.mail.providers.Account)}.
     ...
     * status change).
     * The change of current folder calls {@link #updateFolder(com.android.mail.providers.Folder)}.
     ...
     * they showed in the {@link com.android.mail.ui.FolderListFragment} and were not-populated.  The code to
     ...
     * calling {@link #updateFolder(com.android.mail.providers.Folder)} which starts a loader {@link #LOADER_FOLDER_CURSOR}
     ...
     * information encoded in them. So, to obtain a {@link com.android.mail.providers.Folder} object from a {@link android.net.Uri},
     ...
     * list.
     * This loader is started when the user switches folders (in {@link #updateFolder(com.android.mail.providers.Folder)},
     * or when the controller is told that a folder/account change is imminent
     * (in {@link #preloadConvList(com.android.mail.providers.Account, com.android.mail.providers.Folder)}. The loader is maintained for the life of
     ...
     * {@link com.android.mail.providers.FolderWatcher} can create its folder loaders without clashing with the IDs of those
     * of the {@link com.android.mail.ui.AbstractActivityController}. Currently, the {@link com.android.mail.providers.FolderWatcher} is the only
     ...
     * {@link com.android.mail.ui.ConversationListFragment}'s LoaderManager.
     */
     ...
     *
     * Caution! This method returns the {@link com.android.mail.ui.ConversationListFragment} after the fragment has been
     ...
     *
     * Caution! This method returns the {@link com.android.mail.ui.FolderListFragment} after the fragment has been
     * added, <b>and</b> after the {@link android.app.FragmentManager} has run through its queue to add the
     * fragment. There is a non-trivial amount of time after the fragment is instantiated and before
     * this call returns a non-null value, depending on the {@link android.app.FragmentManager}. If you
     * need the fragment immediately after adding it, consider making the fragment an observer of
    ...
    /**
     * Opens an {@link com.android.mail.ui.EmptyFolderDialogFragment} for the current folder.
     */
     ...
     * triggering {@link com.android.mail.ui.ConversationSetObserver} callbacks as our selection set changes.
     *
     */
     ...
     * clients should only require {@link com.android.mail.ui.DestructiveAction}s, not specific implementations of the.
    ...
    /**
     * Called when the {@link com.android.mail.browse.ConversationCursor} is changed or has new data in it.
     * <p>
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * This class handles callbacks that create a {@link com.android.mail.browse.ConversationCursor}.
     */
    ...
    /**
     * Class to perform {@link android.app.LoaderManager.LoaderCallbacks} for creating {@link com.android.mail.providers.Folder} objects.
     */
    ...
    /**
     * Class to perform {@link android.app.LoaderManager.LoaderCallbacks} for creating {@link com.android.mail.providers.Account} objects.
     */
    ...
    /**
     * Destroy the pending {@link com.android.mail.ui.DestructiveAction} till now and assign the given action as the
     ...
     * to control the profusion of {@link com.android.mail.ui.DestructiveAction} classes that are
     * created. Please do not copy this paradigm.
     * @param action the resource ID of the menu action: R.id.delete, for
     *            example
     * @param target the conversations to act upon.
     * @return a {@link com.android.mail.ui.DestructiveAction} that performs the specified action.
     */
    ...
    private class FolderDestruction implements DestructiveAction {
         ...
         * @param actionFolder the {@link com.android.mail.providers.Folder} being acted upon, used for displaying the undo bar
         */
