...
/**
 * {@link com.android.mail.ui.RestrictedActivity} gives access to a subset of {@link android.app.Activity} methods. These methods
 * match the signatures from {@link android.app.Activity}.
 */
public interface RestrictedActivity {
    ...
    /**
     * @see android.app.Activity#startSearch(String, boolean, android.os.Bundle, boolean)
     */
