...
/**
 * A simple extension of {@link android.database.DataSetObserver} to provide the updated recent folders
 * {@link #onChanged()} when they change. Initializing the object registers with
 * the observer with the {@link com.android.mail.providers.RecentFolderObserver} provided. The object will then begin to
 * receive {@link #onChanged()} till {@link #unregisterAndDestroy()} is called.
 * The {@link com.android.mail.ui.RecentFolderList} returned in {@link #initialize(com.android.mail.ui.RecentFolderController)} is updated
 * directly, no new object is created when the recent folder list is updated.
 * <p>
 * To implement an {@link com.android.mail.providers.RecentFolderObserver}, you need to implement the
...
public abstract class RecentFolderObserver extends DataSetObserver {
     ...
     * {@link #initialize(com.android.mail.ui.RecentFolderController)} is called.
     */
    public RecentFolderObserver () {
    }

    /**
     * Initializes an {@link com.android.mail.providers.RecentFolderObserver} object that receives a call to
