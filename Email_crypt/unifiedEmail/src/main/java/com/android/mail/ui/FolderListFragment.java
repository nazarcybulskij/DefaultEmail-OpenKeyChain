 ...
 *         This is created through XML resources as a {@link com.android.mail.ui.DrawerFragment}. Since it is created
 ...
 *         {@link com.android.mail.ui.FolderSelectionActivity} to allow the user to create a shortcut or widget for
...
public class FolderListFragment extends ListFragment implements
    ...
    /** An {@link java.util.ArrayList} of {@link FolderType}s to exclude from displaying. */
    ...
    /**
     * Type of currently selected folder: {@link com.android.mail.adapter.DrawerItem#FOLDER_INBOX},
     * {@link com.android.mail.adapter.DrawerItem#FOLDER_RECENT} or {@link com.android.mail.adapter.DrawerItem#FOLDER_OTHER}.
     * Set as {@link com.android.mail.adapter.DrawerItem#UNSET} to begin with, as there is nothing selected yet.
     */
    ...
    /**
     * Creates a new instance of {@link com.android.mail.ui.FolderListFragment}, initialized
    ...
    private interface FolderListFragmentCursorAdapter extends ListAdapter {
         ...
         * com.android.mail.adapter.DrawerItem#VIEW_FOLDER} or {@link com.android.mail.adapter.DrawerItem#VIEW_ACCOUNT}
    ...
    private class FolderListAdapter extends BaseAdapter implements FolderListFragmentCursorAdapter {
         ...
         * {@link com.android.mail.ui.FolderListFragment#mIsDivided} for more information */
        ...
        /**
         * Creates a {@link com.android.mail.ui.FolderListFragment.FolderListAdapter}.This is a list of all the accounts and folders.
         *
         ...
         * populating {@link com.android.mail.ui.FolderListFragment.FolderListAdapter#mItemList}
         */
        ...
        /**
         * Given a list of folders as {@link com.android.mail.adapter.DrawerItem}s, add them as a group.
         ...
         *            {@link com.android.mail.ui.FolderListFragment.FolderListAdapter#NO_HEADER_RESOURCE} if no header
        ...
        /**
         * Add recent folders to the list in order as acquired by the {@link com.android.mail.ui.RecentFolderList}.
         *
         * @param destination List of drawer items to populate
         */
    ...
    /**
     * Checks if the specified {@link com.android.mail.providers.Folder} is a type that we want to exclude from displaying.
     */
    ...
    /**
     * @return the choice mode to use for the {@link android.widget.ListView}
     */
