 ...
 * or a header (a resource string). A {@link com.android.mail.adapter.DrawerItem} can only be one type and can never
 * switch types. Items are created using methods like
 * {@link com.android.mail.adapter.DrawerItem#ofAccount(com.android.mail.ui.ControllableActivity,
 com.android.mail.providers.Account, int, boolean, BidiFormatter)},
 * {@link com.android.mail.adapter.DrawerItem#ofWaitView(com.android.mail.ui.ControllableActivity, BidiFormatter)}, etc.
 *
...
public class DrawerItem {
     ...
     *                    {@link com.android.mail.adapter.DrawerItem#FOLDER_INBOX}, {@link com.android.mail.adapter.DrawerItem#FOLDER_RECENT} or
     *                    {@link com.android.mail.adapter.DrawerItem#FOLDER_OTHER}, or {@link com.android.mail.adapter.DrawerItem#UNSET}.
