 ...
 * (The raw folders string can be obtained from {@link com.android.mail.providers.Conversation#getRawFolders()}.)
 *
 */
public class FolderDisplayer {
     ...
     *
     * @param conv {@link com.android.mail.providers.Conversation} containing the folders to display.
