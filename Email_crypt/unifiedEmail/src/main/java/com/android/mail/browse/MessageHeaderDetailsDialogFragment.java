...
/**
 * {@link android.app.DialogFragment} used by secure conversation views to display
...
public class MessageHeaderDetailsDialogFragment extends DialogFragment {
    ...
    /**
     * Creates a new {@link com.android.mail.browse.MessageHeaderDetailsDialogFragment}.
     * @param addressCache a mapping of RFC822 addresses as strings to {@link com.android.mail.providers.Address}.
     * @param account {@link com.android.mail.providers.Account} used as the from address for any messages created
     ...
     * @return a newly created {@link com.android.mail.browse.MessageHeaderDetailsDialogFragment}
     */
