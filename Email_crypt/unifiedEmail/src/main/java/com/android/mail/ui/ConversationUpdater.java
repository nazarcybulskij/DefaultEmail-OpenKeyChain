...
public interface ConversationUpdater extends ConversationListCallbacks {
     ...
     * @param originalConversationInfo the original unread state of the {@link com.android.mail.providers.ConversationInfo}
     * that {@link com.android.mail.browse.ConversationCursor} will temporarily use until the commit is complete.
     */
     ...
     * {@link com.android.mail.browse.ConversationMessage} to propagate the change to the owning {@link com.android.mail.providers.Conversation}.
     *
     */
    ...
    /**
     * If set, get the listener associated with the existing {@link com.android.mail.browse.ConfirmDialogFragment}.  This
