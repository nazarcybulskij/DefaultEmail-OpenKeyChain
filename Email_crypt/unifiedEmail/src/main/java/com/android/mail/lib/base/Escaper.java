 ...
 * multiple threads.
 *
 * <p>The two primary implementations of this interface are {@link com.android.mail.lib.base.CharEscaper} and {@link
 * com.android.mail.lib.base.UnicodeEscaper}. They are heavily optimized for performance and greatly simplify the task of
 ...
 *
 * <p>Several popular escapers are defined as constants in the class {@link com.android.mail.lib.base.CharEscapers}. To create
 * your own escapers, use {@link com.android.mail.lib.base.CharEscaperBuilder}, or extend {@link com.android.mail.lib.base.CharEscaper} or {@code
 * UnicodeEscaper}.
 *
...
public abstract class Escaper {
   ...
   *
   * <ul>
   * <li>{@link com.android.mail.lib.base.UnicodeEscaper} handles <a href="http://en.wikipedia.org/wiki/UTF-16">UTF-16</a>
   *     correctly, including surrogate character pairs. If the input is badly formed the escaper
   *     should throw {@link IllegalArgumentException}.
   * <li>{@link com.android.mail.lib.base.CharEscaper} handles Java characters independently and does not verify the input
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.Function} that invokes {@link #escape(String)} on this escaper.
   */
