...
public final class ConversationCursor implements Cursor, ConversationCursorOperationListener,
    ...
    private static class UnderlyingCursorWrapper extends ThreadSafeCursorWrapper
         ...
         * <p>
         * Generally, only one task instance per {@link com.android.mail.browse.ConversationCursor.UnderlyingCursorWrapper} will run at a time.
         ...
         * {@link com.android.mail.browse.ConversationCursor.UnderlyingCursorWrapper.CacheLoaderTask#doInBackground(Void...)} for notes on thread safety.
         */
        private CacheLoaderTask mCacheLoaderTask;
        /**
         * The current row that the cache task is working on, or should work on next.
         * <p>
         * Not synchronized; see comments in {@link com.android.mail.browse.ConversationCursor.UnderlyingCursorWrapper.CacheLoaderTask#doInBackground(Void...)} for
     ...
     * {@link #getOperationForConversation(com.android.mail.providers.Conversation, int, android.content.ContentValues)}.
     * @return the sequence number of the operation (for undo)
     */
     ...
     * The {@link com.android.mail.ui.ConversationListFragment} relies on this behavior of
     * {@link com.android.mail.browse.ConversationCursor#hashCode()} to avoid storing dangerous references to the cursor.
     * {@inheritDoc}
     */
    @Override
    public int hashCode() {
