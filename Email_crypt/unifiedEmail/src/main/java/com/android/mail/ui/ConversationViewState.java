...
public class ConversationViewState implements Parcelable {
    ...
    public static final class ExpansionState {
        ...
        /**
         * Returns true if the {@link com.android.mail.ui.ConversationViewState.ExpansionState} is
     ...
     * (see {@link com.android.mail.ui.ConversationViewState.ExpansionState}).
     */
     ...
     * {@link #setReadState(com.android.mail.providers.Message, boolean)}. Returns an empty set for read conversations.
     *
     */
    ...
    static class MessageViewState implements Parcelable {
        ...
        public boolean read;
        /**
         * See {@link com.android.mail.ui.ConversationViewState.ExpansionState} for values.
         *
         */
