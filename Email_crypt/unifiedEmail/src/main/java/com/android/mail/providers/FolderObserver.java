 ...
 * {@link #onChanged(com.android.mail.providers.Folder)} when the Folder changes. Initializing the object registers with
 * the observer with the {@link com.android.mail.ui.FolderController} provided. The object will then begin to
 * receive {@link #onChanged(com.android.mail.providers.Folder)} till {@link #unregisterAndDestroy()} is called.
 * <p>
 * To implement an {@link com.android.mail.providers.FolderObserver}, you need to implement the {@link #onChanged(com.android.mail.providers.Folder)}
 * method.
 */
public abstract class FolderObserver extends DataSetObserver {
     ...
     * {@link #initialize(com.android.mail.ui.FolderController)} is called.
     */
    public FolderObserver () {
    }

    /**
     * Initializes an {@link com.android.mail.providers.FolderObserver} object that receives a call to
     * {@link #onChanged(com.android.mail.providers.Folder)} when the controller changes the Folder.
     *
     * @param controller
     */
    ...
    /**
     * Callback invoked when the Folder object is changed.  Since {@link com.android.mail.providers.Folder} objects are
