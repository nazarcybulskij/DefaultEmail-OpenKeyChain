...
public final class RecentFolderList {
    ...
    private class StoreRecent extends AsyncTask<Void, Void, Void> {
        /**
         * Copy {@link com.android.mail.ui.RecentFolderList#mAccount} in case the account changes between when the
    ...
    /**
     * Initialize the {@link com.android.mail.ui.RecentFolderList} with a controllable activity.
     ...
     * {@link #setCurrentAccount(com.android.mail.providers.Account)} has been called.
