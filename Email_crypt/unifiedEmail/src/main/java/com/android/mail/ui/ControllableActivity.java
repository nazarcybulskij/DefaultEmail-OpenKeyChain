...
public interface ControllableActivity extends HelpCallback, RestrictedActivity,
    ...
    /**
     * Returns the object that handles {@link com.android.mail.ui.ConversationListCallbacks} that is associated with
     * this activity.
     * @return
     */
    ...
    /**
     * Returns the {@link com.android.mail.ui.FolderController} object associated with this activity, if any.
     * @return
     */
    FolderController getFolderController();

    /**
     * Returns the {@link com.android.mail.ui.AccountController} object associated with this activity, if any.
     * @return
     */
    AccountController getAccountController();

    /**
     * Returns the {@link com.android.mail.ui.RecentFolderController} object associated with this activity, if any.
     * @return
     */
    ...
    /**
     * Returns the {@link com.android.mail.ui.FragmentLauncher} object associated with this activity, if any.
     */
