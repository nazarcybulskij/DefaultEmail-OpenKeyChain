...
public class MessageCursor extends ObjectCursor<ConversationMessage> {
    /**
     * The current controller that this cursor can use to reference the owning {@link com.android.mail.providers.Conversation},
     * and a current {@link com.android.mail.ui.ConversationUpdater}. Since this cursor will survive a rotation, but
