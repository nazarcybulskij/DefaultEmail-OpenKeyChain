 ...
 * {@link android.webkit.WebView} and a number of overlay views that draw on top of the WebView. In the Mail app,
 ...
 * {@link #forwardFakeMotionEvent(android.view.MotionEvent, int)} method that deals with one WebView
 * idiosyncrasy: it doesn't react well when touch MOVE events stream in without a preceding DOWN.
 *
 * <h5>VIEW RECYCLING</h5>
 * Normally, it would make sense to put all overlay views into a {@link android.widget.ListView}. But this view
...
public class ConversationContainer extends ViewGroup implements ScrollListener {
    ...
    /**
     * Current document zoom scale per {@link android.webkit.WebView#getScale()}. This is the ratio of actual
    ...
    /**
     * System touch-slop distance per {@link android.view.ViewConfiguration#getScaledTouchSlop()}.
     */
    private final int mTouchSlop;
    /**
     * Current scroll position, as dictated by the background {@link android.webkit.WebView}.
     */
     ...
     * WebView internal logic requires that a stream of {@link android.view.MotionEvent#ACTION_MOVE} events be
     * preceded by a {@link android.view.MotionEvent#ACTION_DOWN} event.
     */
    private boolean mTouchIsDown = false;
    /**
     * Remember if touch interception was triggered on a {@link android.view.MotionEvent#ACTION_POINTER_DOWN},
     * so we can send a make-up event in {@link #onTouchEvent(android.view.MotionEvent)}.
     */
     ...
     * <p>
     * We keep {@link com.android.mail.browse.ConversationContainer.OverlayView} wrappers instead of bare views so that when it's time to dispose
     ...
     * {@link com.android.mail.browse.ConversationOverlayItem#canPushSnapHeader()}. We calculate this after a pass through
    ...
    public interface DetachListener {
         ...
         * {@link com.android.mail.browse.ConversationContainer} view recycling.
         */
    ...
    /**
     * Touch slop code was copied from {@link android.widget.ScrollView#onInterceptTouchEvent(android.view.MotionEvent)}.
     */
    @Override
...
//                ev.getActionMasked(), ev.getX(), ev.getY(), ev.getPointerCount());
    ...
    /**
     * Copied/stolen from {@link android.widget.ListView}.
     */
     ...
     * {@link #onGeometryChange(com.android.mail.browse.ConversationContainer.OverlayPosition[])} is
     ...
     * {@link #onGeometryChange(com.android.mail.browse.ConversationContainer.OverlayPosition[])}
