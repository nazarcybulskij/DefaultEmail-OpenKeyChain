...
public final class CharEscapers {
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.CharEscaper} that does no escaping.
   */
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.CharEscaper} instance that escapes special characters in a
  ...
  /**
   * Returns an {@link com.android.mail.lib.base.Escaper} instance that escapes Java chars so they can be
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.Escaper} instance that escapes Java characters so they can
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.Escaper} instance that escapes Java characters in a manner
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.CharEscaper} instance that replaces non-ASCII characters
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.CharEscaper} instance that escapes special characters from
  ...
  /**
   * Returns a {@link com.android.mail.lib.base.CharEscaper} instance that escapes non-ASCII characters in
  ...
  /**
   * Returns a composite {@link com.android.mail.lib.base.CharEscaper} instance that tries to escape
  ...
  /**
   * A fast {@link com.android.mail.lib.base.CharEscaper} that uses an array of replacement characters and
  ...
  private static abstract class FastCharEscaper extends CharEscaper {
    ...
    /** Overridden for performance (see {@link com.android.mail.lib.base.CharEscapers.FastCharEscaper}). */
