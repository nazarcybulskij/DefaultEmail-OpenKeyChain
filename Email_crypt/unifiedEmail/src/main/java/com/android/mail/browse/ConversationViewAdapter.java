 ...
 * get an adapter item.
 * <p>
 * Each item in this adapter is a {@link com.android.mail.browse.ConversationOverlayItem} to expose enough information
 * to {@link com.android.mail.browse.ConversationContainer} so that it can position overlays properly.
 *
 */
public class ConversationViewAdapter extends BaseAdapter {
    ...
    public ConversationViewAdapter(ControllableActivity controllableActivity,
            ...
            OnClickListener scbListener, Map<String, Address> addressCache,
