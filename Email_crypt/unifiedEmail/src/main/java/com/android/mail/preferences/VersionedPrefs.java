 ...
 * {@value com.android.mail.preferences.VersionedPrefs#PREFS_VERSION_NUMBER}
 */
public abstract class VersionedPrefs {
    ...
    /** The key for the version number of the {@link android.content.SharedPreferences} file. */
    private static final String PREFS_VERSION_NUMBER = "prefs-version-number";

    /**
     * The current version number for {@link android.content.SharedPreferences}. This is a constant for all
    ...
    /**
     * @param sharedPrefsName The name of the {@link android.content.SharedPreferences} file to use
     */
    ...
    /**
     * Returns the current version of the {@link android.content.SharedPreferences} file.
     */
    ...
    /**
     * Upgrades the {@link android.content.SharedPreferences} file.
     *
    ...
    /**
     * Notifies {@link android.app.backup.BackupManager} that we have new data to back up.
     */
