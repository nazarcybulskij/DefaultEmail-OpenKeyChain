...
public abstract class DrawerClosedObserver extends DataSetObserver {
    ...
    /**
     * Initialize the {@link com.android.mail.providers.DrawerClosedObserver} object to receive calls when the drawer
     * is closed.
     *
     * @param controller
     */
    ...
    /**
     * Unregisters the {@link com.android.mail.providers.DrawerClosedObserver} and makes it unusable.
     */
