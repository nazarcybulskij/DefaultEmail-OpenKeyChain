...
public class ContiguousFIFOAggregator<T> {
     ...
     * will call {@link #expect(Object, com.android.bitmap.ContiguousFIFOAggregator.Callback)}. This means that the expected
     ...
     *
     * @param key the key previously declared in {@link #expect(Object, com.android.bitmap.ContiguousFIFOAggregator.Callback)}.
     *
     */
