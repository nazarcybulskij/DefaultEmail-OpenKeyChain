 ...
 * A {@link com.android.bitmap.DecodeTask.BitmapView} client may be notified on decode begin and completion.
 * <p>
 * This class uses {@link android.graphics.BitmapRegionDecoder} when possible to minimize unnecessary decoding
 ...
 *  {@link com.android.bitmap.ReusableBitmap} will be marked as not reusable
 *  ({@link com.android.bitmap.ReusableBitmap#isEligibleForPooling()} will return false).
 */
public class DecodeTask extends AsyncTask<Void, Void, ReusableBitmap> {
     ...
     * {@link #createFd()} or {@link #createInputStream()}. {@link com.android.bitmap.DecodeTask} will prioritize
     * {@link #createFd()} before falling back to {@link #createInputStream()}.
     * <p>
     * When {@link com.android.bitmap.DecodeTask} is used in conjunction with a {@link com.android.bitmap.BitmapCache}, objects of this
