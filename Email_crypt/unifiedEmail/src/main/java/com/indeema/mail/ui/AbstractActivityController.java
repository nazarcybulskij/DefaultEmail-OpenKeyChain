...
import com.indeema.mail.browse.ConversationItemViewModel;
import com.indeema.mail.browse.ConversationMessage;
import com.indeema.mail.browse.ConversationPagerController;
import com.indeema.mail.browse.SelectedConversationsActionMenu;
import com.indeema.mail.browse.SyncErrorDialogFragment;
...
import com.indeema.mail.providers.FolderWatcher;
import com.indeema.mail.providers.MailAppProvider;
import com.indeema.mail.providers.Settings;
import com.indeema.mail.providers.SuggestionsProvider;
import com.indeema.mail.providers.UIProvider;
import com.indeema.mail.providers.UIProvider.AccountCapabilities;
import com.indeema.mail.providers.UIProvider.AccountColumns;
import com.indeema.mail.providers.UIProvider.AccountCursorExtraKeys;
import com.indeema.mail.providers.UIProvider.AutoAdvance;
import com.indeema.mail.providers.UIProvider.ConversationColumns;
import com.indeema.mail.providers.UIProvider.ConversationOperations;
import com.indeema.mail.providers.UIProvider.FolderCapabilities;
import com.indeema.mail.providers.UIProvider.FolderType;
import com.indeema.mail.ui.ActionableToastBar.ActionClickedListener;
import com.indeema.mail.utils.ContentProviderTask;
import com.indeema.mail.utils.DrawIdler;
import com.indeema.mail.utils.LogTag;
import com.indeema.mail.utils.LogUtils;
import com.indeema.mail.utils.NotificationActionUtils;
import com.indeema.mail.utils.Observable;
import com.indeema.mail.utils.Utils;
import com.indeema.mail.utils.VeiledAddressMatcher;
...
public abstract class AbstractActivityController implements ActivityController,
    ...
    /** Tag for {@link com.indeema.mail.ConversationListContext#searchQuery} */
    ...
    /** A map of {@link com.indeema.mail.providers.Folder} {@link android.net.Uri} to scroll position in the conversation list. */
     ...
     * <p>
     * Per docs in {@link android.app.FragmentManager#beginTransaction()}, this flag starts out true, switches
     * to false after {@link android.app.Activity#onSaveInstanceState}, and becomes true again in both onStart
     * and onResume.
     */
    ...
    /** Object that listens to all LoaderCallbacks that result in {@link com.indeema.mail.providers.Folder} creation. */
    private final FolderLoads mFolderCallbacks = new FolderLoads();
    /** Object that listens to all LoaderCallbacks that result in {@link com.indeema.mail.providers.Account} creation. */
     ...
     * {@link #onCreate(android.os.Bundle)} and in {@link #onActivityResult(int, int, android.content.Intent)}. It is never
     ...
     * The loader is always restarted when an account is set in {@link #setAccount(com.indeema.mail.providers.Account)}.
     ...
     * status change).
     * The change of current folder calls {@link #updateFolder(com.indeema.mail.providers.Folder)}.
     ...
     * calling {@link #updateFolder(com.indeema.mail.providers.Folder)} which starts a loader {@link #LOADER_FOLDER_CURSOR}
     ...
     * a new activity is created with {@link android.content.Intent#ACTION_SEARCH}. For this new activity,
     ...
     * information encoded in them. So, to obtain a {@link com.indeema.mail.providers.Folder} object from a {@link android.net.Uri},
     ...
     * list.
     * This loader is started when the user switches folders (in {@link #updateFolder(com.indeema.mail.providers.Folder)},
     * or when the controller is told that a folder/account change is imminent
     * (in {@link #preloadConvList(com.indeema.mail.providers.Account, com.indeema.mail.providers.Folder)}. The loader is maintained for the life of
     ...
     * {@link com.indeema.mail.providers.FolderWatcher} can create its folder loaders without clashing with the IDs of those
     * of the {@link AbstractActivityController}. Currently, the {@link com.indeema.mail.providers.FolderWatcher} is the only
    ...
    private void attachActionBar() {
        ...
        if (actionBar != null && mActionBarView != null) {
            actionBar.setCustomView(mActionBarView, new LayoutParams(
    ...
    private void markConversationsRead(final Collection<Conversation> targets, final boolean read,
        ...
        final List<ConversationCursor.ConversationOperation> opList = new ArrayList<ConversationCursor.ConversationOperation>(size);
        for (final Conversation target : targets) {
            ...
            opList.add(mConversationListCursor.getOperationForConversation(
                    target, ConversationCursor.ConversationOperation.UPDATE, value));
    ...
    private void displayAutoAdvanceDialogAndPerformAction(final Runnable operation) {
        ...
        final OnClickListener listClickListener =
                new OnClickListener() {
                    @Override
    ...
    /**
     * {@link android.app.LoaderManager} currently has a bug in
     * {@link android.app.LoaderManager#restartLoader(int, android.os.Bundle, android.app.LoaderManager.LoaderCallbacks)}
     ...
     * @param args arguments, if any, to be passed to the loader. Use {@link android.os.Bundle#EMPTY} if no
    ...
    /**
     * Called when the {@link com.indeema.mail.browse.ConversationCursor} is changed or has new data in it.
     * <p>
     * {@inheritDoc}
     */
    @Override
    ...
    private class DroppedInStarredAction implements DestructiveAction {
        ...
        public void performAction() {
            ...
            ArrayList<Uri> folderUris;
            ArrayList<Boolean> adds;
            ConversationCursor.ConversationOperation operation;
    ...
    /**
     * Check if the fragment given here is visible. Checking {@link android.app.Fragment#isVisible()} is
    ...
    /**
     * This class handles callbacks that create a {@link com.indeema.mail.browse.ConversationCursor}.
     */
    ...
    /**
     * Class to perform {@link android.app.LoaderManager.LoaderCallbacks} for creating {@link com.indeema.mail.providers.Folder} objects.
     */
    ...
    /**
     * Class to perform {@link android.app.LoaderManager.LoaderCallbacks} for creating {@link com.indeema.mail.providers.Account} objects.
     */
    ...
    private class FolderDestruction implements DestructiveAction {
         ...
         * @param actionFolder the {@link com.indeema.mail.providers.Folder} being acted upon, used for displaying the undo bar
         */
    ...
    private class MailDrawerListener implements DrawerLayout.DrawerListener {
         ...
         * folders. Note, this is the same amount of work done as {@link android.animation.ValueAnimator#ofFloat}.
         */
        @Override
