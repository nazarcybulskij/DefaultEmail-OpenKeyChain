...
import com.indeema.mail.photomanager.LetterTileProvider;
import com.indeema.mail.preferences.AccountPreferences;
import com.indeema.mail.preferences.FolderPreferences;
...
import com.indeema.mail.ui.ImageCanvas.Dimensions;
...
public class NotificationUtils {
     ...
     *                       False, otherwise.
     * @param accountUri The {@link android.net.Uri} of the {@link com.indeema.mail.providers.Account} of the notification
     *                   upon which an action occurred.
     * @param folderUri The {@link android.net.Uri} of the {@link com.indeema.mail.providers.Folder} of the notification
     *                  upon which an action occurred.
     */
    ...
    /**
     * @return an {@link android.content.Intent} which, if launched, will display the corresponding conversation
     */
     ...
     * @param context
     * @param subject Subject of the new message that triggered the notification
     * @param message the {@link com.indeema.mail.providers.Message} to be displayed.
     * @return a {@link CharSequence} suitable for use in
     *         {@link android.support.v4.app.NotificationCompat.BigTextStyle}
     */
     ...
     * @param subject Subject of the new message that triggered the notification
     * @return a {@link CharSequence} suitable for use as a {@link android.app.Notification} title.
     */
     ...
     * to be stored in {@link com.indeema.mail.preferences.AccountPreferences}. If it is still there, we need to move it to the
     * {@link com.indeema.mail.preferences.FolderPreferences} now.
     */
