...
/**
 * An adapter for translating a cursor of {@link com.indeema.mail.providers.Folder} to a set of selectable views to be used for
...
public class FolderSelectorAdapter extends BaseAdapter {
     ...
     * hierarchical order.
     * @param folderList List of {@link com.indeema.mail.providers.Folder} objects to sort
     */
