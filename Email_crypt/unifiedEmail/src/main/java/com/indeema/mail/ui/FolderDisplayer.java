 ...
 * (The raw folders string can be obtained from {@link com.indeema.mail.providers.Conversation#getRawFolders()}.)
 *
 */
public class FolderDisplayer {
     ...
     *
     * @param conv {@link com.indeema.mail.providers.Conversation} containing the folders to display.
     * @param ignoreFolderUri (optional) folder to omit from the displayed set
     * @param ignoreFolderType -1, or the {@link com.indeema.mail.providers.UIProvider.FolderType} to omit from the displayed set
     */
