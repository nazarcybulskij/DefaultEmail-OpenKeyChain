...
package com.indeema.mail.photomanager;
...
public abstract class PhotoManager implements ComponentCallbacks2, Callback {
    ...
    protected abstract class PhotoLoaderThread extends HandlerThread implements Callback {
        ...
        /**
         * Return photos mapped from {@link PhotoManager.Request#getKey()} to the photo for
         * that request.
         */
        ...
        private void loadPhotosInBackground() {
            ...
            final Collection<Request> loadRequests = new HashSet<Request>();
            final Collection<Request> decodeRequests = new HashSet<Request>();
    ...
    public final class Request implements Comparable<Request> {
        ...
        /**
         * @see PhotoManager.PhotoIdentifier#getKey()
         */
