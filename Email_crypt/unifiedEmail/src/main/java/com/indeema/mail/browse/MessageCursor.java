...
import com.indeema.mail.providers.UIProvider.CursorExtraKeys;
import com.indeema.mail.providers.UIProvider.CursorStatus;
...
public class MessageCursor extends ObjectCursor<ConversationMessage> {
    /**
     * The current controller that this cursor can use to reference the owning {@link com.indeema.mail.providers.Conversation},
     * and a current {@link com.indeema.mail.ui.ConversationUpdater}. Since this cursor will survive a rotation, but
