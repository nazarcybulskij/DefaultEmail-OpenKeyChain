...
import com.indeema.mail.content.ThreadSafeCursorWrapper;
...
import com.indeema.mail.providers.UIProvider.ConversationListQueryParameters;
...
import com.indeema.mail.utils.NotificationActionUtils.NotificationAction;
import com.indeema.mail.utils.NotificationActionUtils.NotificationActionType;
...
public final class ConversationCursor implements Cursor, ConversationCursorOperationListener,
    ...
    private static class UnderlyingCursorWrapper extends ThreadSafeCursorWrapper
         ...
         * <p>
         * Generally, only one task instance per {@link ConversationCursor.UnderlyingCursorWrapper} will run at a time.
         ...
         * {@link ConversationCursor.UnderlyingCursorWrapper.CacheLoaderTask#doInBackground(Void...)} for notes on thread safety.
         */
        private CacheLoaderTask mCacheLoaderTask;
        /**
         * The current row that the cache task is working on, or should work on next.
         * <p>
         * Not synchronized; see comments in {@link ConversationCursor.UnderlyingCursorWrapper.CacheLoaderTask#doInBackground(Void...)} for
     ...
     * {@link #getOperationForConversation(com.indeema.mail.providers.Conversation, int, android.content.ContentValues)}.
     * @return the sequence number of the operation (for undo)
     */
     ...
     * The {@link com.indeema.mail.ui.ConversationListFragment} relies on this behavior of
    ...
    public void markContentsSeen() {
        OperationHelper.markContentsSeen(mUnderlyingCursor);
    }

    @Override
    public void emptyFolder() {
        OperationHelper.emptyFolder(mUnderlyingCursor);
    }
}
