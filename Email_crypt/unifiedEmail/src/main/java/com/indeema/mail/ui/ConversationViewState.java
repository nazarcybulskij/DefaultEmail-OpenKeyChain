...
public class ConversationViewState implements Parcelable {
    ...
    public static final class ExpansionState {
        ...
        /**
         * Returns true if the {@link ConversationViewState.ExpansionState} is
     ...
     * (see {@link ConversationViewState.ExpansionState}).
     */
     ...
     * {@link #setReadState(com.indeema.mail.providers.Message, boolean)}. Returns an empty set for read conversations.
     *
     */
    ...
    static class MessageViewState implements Parcelable {
        ...
        public boolean read;
        /**
         * See {@link ConversationViewState.ExpansionState} for values.
         *
         */
