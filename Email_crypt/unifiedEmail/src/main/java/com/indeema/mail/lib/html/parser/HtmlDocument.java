 ...
 */
package com.indeema.mail.lib.html.parser;

import com.indeema.mail.lib.base.CharEscapers;
import com.indeema.mail.lib.base.CharMatcher;
import com.indeema.mail.lib.base.StringUtil;
import com.indeema.mail.lib.base.X;
...
public class HtmlDocument {
   ...
   * @see HtmlDocument#createTag(com.indeema.mail.lib.html.parser.HTML.Element, java.util.List, String, String)
   */
  ...
  /**
   * Creates start Tag Node.
   * @see HtmlDocument.Tag#Tag(com.indeema.mail.lib.html.parser.HTML.Element, java.util.List, boolean, String, String)
   */
   ...
   * @see HtmlDocument#createSelfTerminatingTag(com.indeema.mail.lib.html.parser.HTML.Element, java.util.List, String, String)
   */
  ...
  /**
   * @see HtmlDocument#createEndTag(com.indeema.mail.lib.html.parser.HTML.Element, String)
   */
  ...
  /**
   * @see HtmlDocument.EndTag#EndTag(com.indeema.mail.lib.html.parser.HTML.Element, String)
   */
  ...
  /**
   * @see HtmlDocument#createTagAttribute(com.indeema.mail.lib.html.parser.HTML.Attribute, String, String)
   */
  ...
  /**
   * @see HtmlDocument.TagAttribute#TagAttribute(com.indeema.mail.lib.html.parser.HTML.Attribute, String, String)
   */
  ...
  /**
   * Creates a Text node.
   * @see HtmlDocument.UnescapedText#UnescapedText(String, String)
   */
   ...
   * @see HtmlDocument.Comment#Comment(String)
   */
   ...
   * @see HtmlDocument.CDATA#CDATA(String)
   */
  ...
  /**
   * {@link HtmlDocument.Text} implementation where the given text is assumed to have been
  ...
  /**
   * {@link HtmlDocument.Text} implementation where the given text is not unescaped yet, and
  ...
  /**
   * Converts a normal {@link HtmlDocument.Filter} into a {@link HtmlDocument.MultiplexFilter}.
   */
  ...
  public static abstract class SimpleMultiplexFilter implements MultiplexFilter {
    ...
    /**
     * @see HtmlDocument.MultiplexFilter#filter(HtmlDocument.Node, java.util.List)
     */
    public void filter(Node originalNode, List<Node> out) {
      if (originalNode == null) {
        return;
  ...
  public static class MultiplexFilterChain implements MultiplexFilter {
    ...
    /**
     * @see HtmlDocument.MultiplexFilter#finish(java.util.List)
     */
    public void finish(List<Node> out) {
      List<Node> result = new ArrayList<Node>();
  ...
  public static class Builder implements Visitor {
    ...
    /**
     * @see HtmlDocument.Builder#Builder(boolean)
     */
    public Builder() {
      this(false);
    }
