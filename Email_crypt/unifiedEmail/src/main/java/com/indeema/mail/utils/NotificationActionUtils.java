 ...
 */
package com.indeema.mail.utils;
...
public class NotificationActionUtils {
    ...
    /**
     * If an {@link NotificationActionUtils.NotificationAction} exists here for a given notification key, then we should
    ...
    /**
     * If a {@link com.indeema.mail.providers.Conversation} exists in this set, then the undo notification for this
     * {@link com.indeema.mail.providers.Conversation} was tapped by the user in the notification drawer.
     ...
     *
     * @param notificationIntent The {@link android.content.Intent} used when the notification is clicked
     ...
     * @param notificationActions A {@link java.util.Set} set of the actions to display
     */
     ...
     *
     * @param folder The {@link com.indeema.mail.providers.Folder} being notified
    ...
    /**
     * Creates a {@link android.app.PendingIntent} for the specified notification action.
     */
    ...
    /**
     * Creates a {@link android.app.PendingIntent} to be used for creating and canceling the undo timeout
     * alarm.
     */
    ...
    /**
     * Creates and displays an Undo notification for the specified {@link NotificationActionUtils.NotificationAction}.
     */
    ...
    /**
     * Broadcasts an {@link android.content.Intent} to inform the app to resend its notifications.
     */
