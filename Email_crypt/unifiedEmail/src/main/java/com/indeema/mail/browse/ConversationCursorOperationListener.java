...
public interface ConversationCursorOperationListener {
    ...
    public class OperationHelper {
        /**
         * Invokes {@link ConversationCursorOperationListener#markContentsSeen(android.database.Cursor)} on the
        ...
        /**
         * Invokes {@link ConversationCursorOperationListener#emptyFolder(android.database.Cursor)} on the
