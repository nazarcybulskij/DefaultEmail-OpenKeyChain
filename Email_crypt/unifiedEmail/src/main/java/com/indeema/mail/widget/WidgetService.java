...
import com.indeema.mail.utils.DelayedTaskHandler;
...
public class WidgetService extends RemoteViewsService {
    ...
    protected static class MailFactory
        ...
        public MailFactory(Context context, Intent intent, WidgetService service) {
            ...
            mFolderType = intent.getIntExtra(WidgetProvider.EXTRA_FOLDER_TYPE, UIProvider.FolderType.DEFAULT);
        ...
        public void onCreate() {
            ...
            final Uri widgetConversationQueryUri = builder
                    .appendQueryParameter(UIProvider.ConversationListQueryParameters.LIMIT, maxConversations)
                    .appendQueryParameter(UIProvider.ConversationListQueryParameters.USE_NETWORK,
                            Boolean.FALSE.toString())
                    .appendQueryParameter(UIProvider.ConversationListQueryParameters.ALL_NOTIFICATIONS,
        ...
        /**
         * @return the {@link android.widget.RemoteViews} for a specific position in the list.
         */
        @Override
        public RemoteViews getViewAt(int position) {
            synchronized (sWidgetLock) {
                ...
                if ((mFolderType & UIProvider.FolderType.INBOX) != 0) {
        ...
        /**
         * A {@link com.indeema.mail.utils.DelayedTaskHandler} to throttle folder update to a reasonable rate.
         */
