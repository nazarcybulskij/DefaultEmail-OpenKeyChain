...
public class Utils {
    ...
    /**
     * Returns a {@link com.google.android.mail.common.html.parser.HtmlTree} representation of the specified HTML string.
     */
    ...
    public static void showAccountSettings(Context context, Account account) {
        ...
        settingsIntent.putExtra(UIProvider.EditSettingsExtras.EXTRA_ACCOUNT, account);
        settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
        context.startActivity(settingsIntent);
    }
     ...
     */
     public static void showFolderSettings(Context context, Account account, Folder folder) {
        ...
        settingsIntent.putExtra(UIProvider.EditSettingsExtras.EXTRA_ACCOUNT, account);
        settingsIntent.putExtra(UIProvider.EditSettingsExtras.EXTRA_FOLDER, folder);
        settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
        context.startActivity(settingsIntent);
    }
     ...
     */
     public static void showManageFolder(Context context, Account account) {
         ...
         settingsIntent.putExtra(UIProvider.EditSettingsExtras.EXTRA_ACCOUNT, account);
         settingsIntent.putExtra(UIProvider.EditSettingsExtras.EXTRA_MANAGE_FOLDERS, true);
         settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
         context.startActivity(settingsIntent);
    }
   ...
   /**
    * (copied from {@link android.content.Intent#normalizeMimeType(String)} for pre-J)
    *
   ...
   /**
    * (copied from {@link android.net.Uri#normalize()} for pre-J)
    *
   ...
   public static int getTransparentColor(int color) {
    ...
    /**
     * Gets the specified {@link com.indeema.mail.providers.Folder} object.
     *
     * @param folderUri The {@link android.net.Uri} for the folder
     * @param allowHidden <code>true</code> to allow a hidden folder to be returned,
     *        <code>false</code> to return <code>null</code> instead
     * @return the specified {@link com.indeema.mail.providers.Folder} object, or <code>null</code>
     */
