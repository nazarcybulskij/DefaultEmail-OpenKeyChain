...
public final class MailPrefs extends VersionedPrefs {
     ...
     * Should be one of the {@link MailPrefs.RemovalActions}.
     */
     ...
     * @param removalAction The preferred {@link MailPrefs.RemovalActions}.
     */
    ...
    /**
     * Gets the action to take (one of the values from {@link com.indeema.mail.providers.UIProvider.Swipe}) when an item in the
