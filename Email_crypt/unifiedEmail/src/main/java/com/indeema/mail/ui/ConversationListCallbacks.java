...
public interface ConversationListCallbacks {
     ...
     * @param inLoaderCallbacks whether we are in the scope of a {@link android.app.LoaderManager.LoaderCallbacks} method
     ...
     * ({@link #registerConversationLoadedObserver(android.database.DataSetObserver)}).
     * <p>
     ...
     *
     * @return A {@link android.os.Bundle} containing two ints,
     ...
     *
     * @param savedPosition A {@link android.os.Bundle} containing two ints,
     *            {@link #CONVERSATION_LIST_SCROLL_POSITION_INDEX} and
