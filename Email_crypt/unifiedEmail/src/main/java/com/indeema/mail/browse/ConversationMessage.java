 ...
 * handy to have the owning {@link com.indeema.mail.providers.Conversation} for context.
 *
 ...
 * {@link com.indeema.mail.browse.MessageCursor.ConversationController} intermediate is used to obtain the currently opened cursor.
 *
 * <p>(N.B. This is a {@link android.os.Parcelable}, so try not to add non-transient fields here.
 * Parcelable state belongs either in {@link com.indeema.mail.providers.Message} or
 * {@link com.indeema.mail.ui.ConversationViewState.MessageViewState}. The
...
public final class ConversationMessage extends Message {
    ...
    public void setController(MessageCursor.ConversationController controller) {
