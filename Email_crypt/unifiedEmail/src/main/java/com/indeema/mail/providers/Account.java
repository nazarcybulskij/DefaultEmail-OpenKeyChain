...
public class Account implements Parcelable {
     ...
     * where the keys are from the {@link com.indeema.mail.providers.UIProvider.AccountColumns.SettingsColumns}, and the values are the
     * new values.
     */
     ...
     * {@link android.content.ContentResolver#getSyncAutomatically} calls to check for whether sync is enabled
    ...
    public synchronized String serialize() {
        ...
        try {
            ...
            json.put(UIProvider.AccountColumns.ACCOUNT_MANAGER_NAME, accountManagerName);
            ...
            json.put(UIProvider.AccountColumns.ALL_FOLDER_LIST_URI, allFolderListUri);
            ...
            json.put(UIProvider.AccountColumns.REAUTHENTICATION_INTENT_URI, reauthenticationIntentUri);
            ...
            json.put(UIProvider.AccountColumns.DEFAULT_RECENT_FOLDER_LIST_URI, defaultRecentFolderListUri);
            json.put(UIProvider.AccountColumns.MANUAL_SYNC_URI, manualSyncUri);
            json.put(UIProvider.AccountColumns.VIEW_INTENT_PROXY_URI, viewIntentProxyUri);
            ...
            json.put(UIProvider.AccountColumns.QUICK_RESPONSE_URI, quickResponseUri);
            if (settings != null) {
    ...
    private Account(String acctName, String acctType, String jsonAccount) throws JSONException {
        ...
        final String amName = json.optString(UIProvider.AccountColumns.ACCOUNT_MANAGER_NAME);
        ...
        allFolderListUri = Utils.getValidUri(json
                .optString(UIProvider.AccountColumns.ALL_FOLDER_LIST_URI));
        ...
        helpIntentUri = Utils.getValidUri(json.optString(UIProvider.AccountColumns.HELP_INTENT_URI));
        ...
        enableMessageTransforms = json.optInt(UIProvider.AccountColumns.ENABLE_MESSAGE_TRANSFORMS);
        syncAuthority = json.optString(UIProvider.AccountColumns.SYNC_AUTHORITY);
        quickResponseUri = Utils.getValidUri(json.optString(UIProvider.AccountColumns.QUICK_RESPONSE_URI));
    ...
    public Account(Cursor cursor) {
        ...
        enableMessageTransforms = cursor.getInt(
                cursor.getColumnIndex(UIProvider.AccountColumns.ENABLE_MESSAGE_TRANSFORMS));
        syncAuthority = cursor.getString(
                cursor.getColumnIndex(UIProvider.AccountColumns.SYNC_AUTHORITY));
        ...
        quickResponseUri = Utils.getValidUri(cursor.getString(
                cursor.getColumnIndex(UIProvider.AccountColumns.QUICK_RESPONSE_URI)));
    ...
    public boolean isAccountSyncRequired() {
        return (syncStatus & UIProvider.SyncStatus.INITIAL_SYNC_NEEDED) == UIProvider.SyncStatus.INITIAL_SYNC_NEEDED;
    }

    public boolean isAccountInitializationRequired() {
        return (syncStatus & UIProvider.SyncStatus.ACCOUNT_INITIALIZATION_REQUIRED) ==
                UIProvider.SyncStatus.ACCOUNT_INITIALIZATION_REQUIRED;
    }
    ...
    public List<ReplyFromAccount> getReplyFroms() {
        ...
        if (mReplyFroms == null) {
            ...
            if (supportsCapability(UIProvider.AccountCapabilities.SENDING_UNAVAILABLE)) {
                return mReplyFroms;
            }
    ...
    /**
     * Creates a {@link java.util.Map} where the column name is the key and the value is the value, which can
     * be used for populating a {@link android.database.MatrixCursor}.
     */
    public Map<String, Object> getValueMap() {
        ...
        map.put(UIProvider.AccountColumns.ACCOUNT_MANAGER_NAME, accountManagerName);
        ...
        map.put(UIProvider.AccountColumns.ALL_FOLDER_LIST_URI, allFolderListUri);
        ...
        map.put(UIProvider.AccountColumns.DEFAULT_RECENT_FOLDER_LIST_URI, defaultRecentFolderListUri);
        ...
        map.put(UIProvider.AccountColumns.QUICK_RESPONSE_URI, quickResponseUri);
