...
import com.indeema.mail.ui.HtmlMessage;
...
public class Message implements Parcelable, HtmlMessage {
    ...
    public Message(Context context, MimeMessage mimeMessage, Uri emlFileUri)
        ...
        setFrom(com.indeema.emailcommon.mail.Address.pack(mimeMessage.getFrom()));
        setTo(Address.pack(mimeMessage.getRecipients(
                com.indeema.emailcommon.mail.Message.RecipientType.TO)));
        setCc(Address.pack(mimeMessage.getRecipients(
                com.indeema.emailcommon.mail.Message.RecipientType.CC)));
        setBcc(Address.pack(mimeMessage.getRecipients(
                com.indeema.emailcommon.mail.Message.RecipientType.BCC)));
     ...
     * {@link com.indeema.mail.providers.UIProvider.MessageColumns#ALWAYS_SHOW_IMAGES} flag set.
     *
