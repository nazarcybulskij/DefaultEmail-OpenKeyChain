...
import com.indeema.mail.ui.AttachmentTileGrid;
import com.indeema.mail.ui.AttachmentTile.AttachmentPreview;
...
class AttachmentsView extends LinearLayout {
    ...
    /**
     * Generate an {@link com.indeema.mail.providers.Attachment} object for a given local content URI. Attempts to populate
     * the {@link com.indeema.mail.providers.Attachment#name}, {@link com.indeema.mail.providers.Attachment#size}, and {@link com.indeema.mail.providers.Attachment#contentType}
     * fields using a {@link android.content.ContentResolver}.
     *
     * @param contentUri
     ...
     * @throws AttachmentsView.AttachmentFailureException if an error occurs adding the attachment.
     */
