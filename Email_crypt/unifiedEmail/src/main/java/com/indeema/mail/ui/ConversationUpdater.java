...
public interface ConversationUpdater extends ConversationListCallbacks {
     ...
     * provided. Column names are listed in {@link com.indeema.mail.providers.UIProvider.ConversationColumns}, for example
     * {@link com.indeema.mail.providers.UIProvider.ConversationColumns#FOLDER_LIST}
     * @param target
     * @param columnName
     * @param value
     */
     ...
     * Modify the given conversation by changing the column provided here to contain the value
     * provided. Column names are listed in {@link com.indeema.mail.providers.UIProvider.ConversationColumns}, for example
     * {@link com.indeema.mail.providers.UIProvider.ConversationColumns#READ}
     * @param target
     * @param columnName
     * @param value
     */
     ...
     * Modify the given conversation by changing the column provided here to contain the value
     * provided. Column names are listed in {@link com.indeema.mail.providers.UIProvider.ConversationColumns}, for example
     * {@link com.indeema.mail.providers.UIProvider.ConversationColumns#HAS_ATTACHMENTS}
     * @param target
     * @param columnName
     * @param value
     */
     ...
     * {@link com.indeema.mail.providers.UIProvider.ConversationColumns}, for example
     * {@link com.indeema.mail.providers.UIProvider.ConversationColumns#HAS_ATTACHMENTS}
     * @param target
     * @param values
     */
     ...
     * @param originalConversationInfo the original unread state of the {@link com.indeema.mail.providers.ConversationInfo}
     * that {@link com.indeema.mail.browse.ConversationCursor} will temporarily use until the commit is complete.
     */
     ...
     * {@link com.indeema.mail.browse.ConversationMessage} to propagate the change to the owning {@link com.indeema.mail.providers.Conversation}.
     *
     */
    ...
    /**
     * If set, get the listener associated with the existing {@link com.indeema.mail.browse.ConfirmDialogFragment}.  This
