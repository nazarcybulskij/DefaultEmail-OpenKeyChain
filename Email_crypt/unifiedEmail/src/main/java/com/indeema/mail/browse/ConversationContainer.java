...
import com.indeema.mail.utils.InputSmoother;
...
public class ConversationContainer extends ViewGroup implements ScrollNotifier.ScrollListener {
     ...
     * <p>
     * We keep {@link ConversationContainer.OverlayView} wrappers instead of bare views so that when it's time to dispose
...
//                ev.getActionMasked(), ev.getX(), ev.getY(), ev.getPointerCount());
     ...
     * {@link #onGeometryChange(ConversationContainer.OverlayPosition[])} is
     ...
     * {@link #onGeometryChange(ConversationContainer.OverlayPosition[])}
