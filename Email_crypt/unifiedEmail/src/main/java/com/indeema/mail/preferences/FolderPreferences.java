 ...
 */
package com.indeema.mail.preferences;
...
public class FolderPreferences extends VersionedPrefs {
    ...
    /**
     * A constructor that can be used when no {@link com.indeema.mail.providers.Folder} object is available (like during a
     * restore). This will function as expected except when calling
     * {@link #getDefaultNotificationActions(android.content.Context)}, so
     * {@link #FolderPreferences(android.content.Context, String, com.indeema.mail.providers.Folder, boolean)} should be used if at all
     * possible.
     *
     * @param accountEmail The account email. This must never change for the account.
