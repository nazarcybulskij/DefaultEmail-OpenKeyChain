...
import com.indeema.mail.R.dimen;
import com.indeema.mail.R.id;
...
public class ConversationItemViewCoordinates {
     ...
     * instance per item, and {@link #forConfig(android.content.Context, ConversationItemViewCoordinates.Config, android.util.SparseArray)} uses it to hide/show
