...
public class ConversationPositionTracker {
    ...
    /**
     * @return the {@link com.indeema.mail.providers.Conversation} of the newer conversation by one position. If no such
    ...
    /**
     * @return the {@link com.indeema.mail.providers.Conversation} of the older conversation by one spot. If no such
     * conversation exists, this method returns null.
     */
