...
import com.indeema.mail.widget.WidgetProvider;
...
public class FolderSelectionActivity extends Activity implements OnClickListener,
    ...
    /**
     * Gets an {@link java.util.ArrayList} of canonical names of any folders to exclude from displaying.
     * By default, this list is empty.
     *
     * @return An {@link java.util.ArrayList} of folder canonical names
     */
