...
package com.indeema.mail.providers;
...
public class UIProvider {
    ...
    public static final class AccountColumns implements BaseColumns {
         ...
         * in {@link UIProvider.SearchQueryParameters}
         * The cursor returned from this query is expected have one row, where the columnm are a
         * subset of the columns specified in {@link UIProvider.FolderColumns}
         */
         ...
         * shown.
         * Optionally, extra values from {@link UIProvider.EditSettingsExtras} can be used to indicate
         ...
         * {@link UIProvider.ConversationColumns#CONVERSATION_BASE_URI} column. The cursor returned from this
         * query is expected have one row, where the columns are specified in
         * {@link UIProvider.AccountCookieColumns}
         */
         ...
         * where the keys are from the {@link UIProvider.AccountColumns.SettingsColumns}, and the values are
         * the new values.
         */
        ...
        public static final class SettingsColumns {
            ...
            /**
             * Integer column containing a value matching one of the constants from {@link UIProvider.Swipe}
             */
             ...
             * constants from  {@link UIProvider.ConversationViewMode}
             */
    ...
    public static final class FolderCapabilities {
         ...
         * {@link com.indeema.mail.ui.MultiFoldersSelectionDialog}).
         */
    ...
    public static final class ConversationColumns {
         ...
         * values with keys listed in {@link UIProvider.CursorExtraKeys}
         */
         ...
         * {@link UIProvider.ConversationCursorCommand#COMMAND_GET_CONVERSATION_INFO} instead.
         */
        @Deprecated
         ...
         *
         * @deprecated providers should implement
         * {@link UIProvider.ConversationCursorCommand#COMMAND_GET_RAW_FOLDERS} instead.
         */
        @Deprecated
         ...
         * {@link UIProvider.ConversationPersonalLevel}.
         */
     ...
     * the {@link UIProvider.ConversationOperations#OPERATION_KEY}
     * <p/>
     * Note not all UI providers will support these operations.  {@link UIProvider.AccountCapabilities} can
    ...
    public static final class AccountCallMethods {
         ...
         * columns specified in {@link UIProvider.MessageColumns}, and if this is a save for an existing
         * message, an entry for the {@link UIProvider.MessageColumns#URI} should reference the existing
         * message
         *
         * The Bundle returned will contain the message uri in the returned bundled with the
         * {@link UIProvider.MessageColumns#URI} key.
         */
         ...
         * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)} should have the
         * columns specified in {@link UIProvider.MessageColumns}, and if this is a send of an existing
         * message, an entry for the {@link UIProvider.MessageColumns#URI} should reference the existing
         * message
         *
         * The Bundle returned will contain the message uri in the returned bundled with the
         ...
         * {@link android.content.ContentResolver#call(android.net.Uri,String,String, android.os.Bundle)} should have the
         * columns specified in {@link UIProvider.SetCurrentAccountColumns}
         *
    ...
    /**
     * Keys used for parameters to {@link UIProvider.AccountCallMethods#SEND_MESSAGE} or
     * {@link UIProvider.AccountCallMethods#SAVE_MESSAGE} methods.
     */
    ...
    public static final class CursorExtraKeys {
         ...
         * one defined in {@link UIProvider.CursorStatus}.
         */
    ...
    public static final class MessageColumns {
         ...
         * draft. See {@link UIProvider.DraftType} for possible values.
         */
         ...
         * can be retrieved using the URI in {@link UIProvider.MessageColumns#ATTACHMENT_LIST_URI}.
         */
        public static final String HAS_ATTACHMENTS = "hasAttachments";
        /**
        ...
        /**
         * This long column is a bit field of flags defined in {@link UIProvider.MessageFlags}.
         */
         ...
         * See {@link UIProvider.SpamWarningLevel} for possible values.
         */
         ...
         * See {@link UIProvider.SpamWarningLinkType} for possible values.
         */
    ...
    /**
     * Valid states for the {@link UIProvider.AttachmentColumns#STATE} column.
     *
     */
    public static final class AttachmentState {
         ...
         * {@link UIProvider.AttachmentColumns#DOWNLOADED_SIZE} should reflect the current
         ...
         * the accompanying destination in {@link UIProvider.AttachmentColumns#DESTINATION}
         * .
         * <p>
         ...
         * {@link UIProvider.AttachmentColumns#DESTINATION}. If a provider later detects
         ...
         * {@link UIProvider.AttachmentColumns#DESTINATION}.
         * <p>
    ...
    public static final class AttachmentColumns {
         ...
         * attachment as defined in {@link UIProvider.AttachmentState}.
         * <p>
         ...
         * {@link UIProvider.AttachmentState#DOWNLOADING}) or the resulting downloaded file
         * ( when {@link #STATE} is {@link UIProvider.AttachmentState#SAVED}), as defined
         * in {@link UIProvider.AttachmentDestination}. This value is undefined in any
         * other state.
         * <p>
         * Providers must accept updates to {@link #URI} with new values of
         ...
         * {@link #STATE} is {@link UIProvider.AttachmentState#DOWNLOADING}. This value is
         ...
         * {@link UIProvider.AttachmentState#SAVED}. This value is undefined in any other
         * state.
         */
         ...
         * {@link UIProvider.AttachmentType} constants.
         */
        public static final String TYPE = "type";
     ...
     * {@link UIProvider.ConversationOperations#OPERATION_KEY}.
     */
     ...
     * {@link UIProvider.UpdateNotificationExtras#EXTRA_FOLDER} {@link UIProvider.UpdateNotificationExtras#EXTRA_ACCOUNT}
     */
    ...
    public static final class UpdateNotificationExtras {
        /**
         * Parcelable extra containing a {@link android.net.Uri} to a {@link Folder}
         */
        public static final String EXTRA_FOLDER = "notification_extra_folder";

        /**
         * Parcelable extra containing a {@link android.net.Uri} to an {@link Account}
         */
