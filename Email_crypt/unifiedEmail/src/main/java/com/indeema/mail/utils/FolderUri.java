...
/**
 * A holder for a Folder {@link android.net.Uri} that can be compared, ignoring any query parameters.
 */
public class FolderUri {
    public static final FolderUri EMPTY = new FolderUri(Uri.EMPTY);

    /**
     * The full {@link android.net.Uri}. This should be used for any queries.
     */
    public final Uri fullUri;
    /**
     * Equivalent to {@link #fullUri}, but without any query parameters, and can safely be used in
     * comparisons to determine if two {@link android.net.Uri}s point to the same object.
     */
