...
public interface ImageCanvas {
     ...
     * to whatever {@link #getDesiredDimensions(Object, ImageCanvas.Dimensions)} reported when the
     ...
     *
     * @param key
     * @param outDim caller-allocated {@link ImageCanvas.Dimensions} object to house the result
     */
