...
import static com.indeema.mail.lib.base.Preconditions.checkNotNull;
import static com.indeema.mail.lib.base.Preconditions.checkState;
 ...
 * #on(String)}, {@link #on(java.util.regex.Pattern)} and {@link #on(CharMatcher)} for examples
