...
import com.indeema.mail.browse.ConversationListFooterView;
import com.indeema.mail.browse.ToggleableItem;
...
public final class ConversationListFragment extends ListFragment implements
        OnItemLongClickListener, ViewMode.ModeChangeListener, SwipeableListView.ListItemSwipedListener {
     ...
     * {@link #onCreate(android.os.Bundle)} and final afterwards.
     */
    ...
    /**
     * See the comment for
     * {@link #onItemLongClick(android.widget.AdapterView, android.view.View, int, long)}.
     * <p>
     * Short tap behavior:
     *
     * <pre>
    ...
    public void requestDelete(int actionId, final Collection<Conversation> conversations,
        ...
        final SwipeableListView.ListItemsRemovedListener listener = new SwipeableListView.ListItemsRemovedListener() {
            @Override
    ...
    private void setSwipeAction() {
        ...
        if (swipeSetting == UIProvider.Swipe.DISABLED
            ...
            if (ConversationListContext.isSearchResult(mViewContext)
                ...
                switch (swipeSetting) {
                    case UIProvider.Swipe.ARCHIVE:
                        if (mAccount.supportsCapability(UIProvider.AccountCapabilities.ARCHIVE)) {
                            if (mFolder.supportsCapability(UIProvider.FolderCapabilities.ARCHIVE)) {
                                action = R.id.archive;
                                break;
