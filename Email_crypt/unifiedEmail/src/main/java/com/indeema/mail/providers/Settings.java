...
import com.indeema.mail.providers.UIProvider.AccountColumns.SettingsColumns;
...
import com.indeema.mail.providers.UIProvider.DefaultReplyBehavior;
import com.indeema.mail.providers.UIProvider.MessageTextSize;
import com.indeema.mail.providers.UIProvider.SnapHeaderValue;
import com.indeema.mail.providers.UIProvider.Swipe;
...
public class Settings implements Parcelable {
    ...
    /**
     * The {@link android.net.Uri} to use when moving a conversation to the inbox. May
    ...
    /**
     * Creates a {@link java.util.Map} where the column name is the key and the value is the value.
     ...
     * returns the empty URI {@link android.net.Uri#EMPTY}
     * @param settings a settings object, possibly null.
     * @return a valid default Inbox URI, or {@link android.net.Uri#EMPTY} if settings are null or no default
     * is specified.
     */
