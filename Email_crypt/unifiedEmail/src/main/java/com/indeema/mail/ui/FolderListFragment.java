...
import com.indeema.mail.adapter.DrawerItem;
...
import com.indeema.mail.providers.AllAccountObserver;
import com.indeema.mail.providers.DrawerClosedObserver;
import com.indeema.mail.providers.Folder;
import com.indeema.mail.providers.FolderObserver;
import com.indeema.mail.providers.FolderWatcher;
import com.indeema.mail.providers.RecentFolderObserver;
import com.indeema.mail.providers.UIProvider;
import com.indeema.mail.utils.FolderUri;
...
public class FolderListFragment extends ListFragment implements
    ...
    /** An {@link java.util.ArrayList} of {@link com.indeema.mail.providers.UIProvider.FolderType}s to exclude from displaying. */
    ...
    /**
     * Type of currently selected folder: {@link com.indeema.mail.adapter.DrawerItem#FOLDER_INBOX},
     * {@link com.indeema.mail.adapter.DrawerItem#FOLDER_RECENT} or {@link com.indeema.mail.adapter.DrawerItem#FOLDER_OTHER}.
     * Set as {@link com.indeema.mail.adapter.DrawerItem#UNSET} to begin with, as there is nothing selected yet.
     */
     ...
     * @param excludedFolderTypes A list of {@link com.indeema.mail.providers.UIProvider.FolderType}s to exclude from displaying
     */
    ...
    private interface FolderListFragmentCursorAdapter extends ListAdapter {
         ...
         * com.indeema.mail.adapter.DrawerItem#VIEW_FOLDER} or {@link com.indeema.mail.adapter.DrawerItem#VIEW_ACCOUNT}
    ...
    private class FolderListAdapter extends BaseAdapter implements FolderListFragmentCursorAdapter {
        ...
        /**
         * Creates a {@link FolderListFragment.FolderListAdapter}.This is a list of all the accounts and folders.
         *
         ...
         * populating {@link FolderListFragment.FolderListAdapter#mItemList}
         */
        ...
        /**
         * Given a list of folders as {@link com.indeema.mail.adapter.DrawerItem}s, add them as a group.
         ...
         *            {@link FolderListFragment.FolderListAdapter#NO_HEADER_RESOURCE} if no header
    ...
    /**
     * Checks if the specified {@link com.indeema.mail.providers.Folder} is a type that we want to exclude from displaying.
     */
