 ...
 * key must have been previously declared with {@link #expect(Object, ContiguousFIFOAggregator.Callback)}.
...
public class ContiguousFIFOAggregator<T> {
     ...
     * will call {@link #expect(Object, ContiguousFIFOAggregator.Callback)}. This means that the expected
     ...
     *
     * @param key the key previously declared in {@link #expect(Object, ContiguousFIFOAggregator.Callback)}.
     *
     */
